...
namespace Crest.Components.RadzenSource
{
    ...
    public partial class RadzenDropDown<TValue> : DropDownBase<TValue>
    {
        ...
        internal DropDownItemRenderEventArgs<TValue> ItemAttributes(CrestDropDownItem<TValue> item)
        {
        ...
        {
            builder.OpenComponent(0, typeof(CrestDropDownItem<TValue>));
        ...
        [Parameter]
        public string SelectedItemsText { get => selectedItemsText ?? Localize(nameof(CrestStrings.DropDown_SelectedItemsText)); set => selectedItemsText = value; }
