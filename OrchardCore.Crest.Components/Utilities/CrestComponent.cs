...
{
    /// <summary>
    /// Base class for all Crest Blazor components providing common functionality for styling, attributes, events, and lifecycle management.
    /// All Crest components inherit from CrestComponent to gain standard features like visibility control, custom attributes, mouse events, and disposal.
    ...
    /// Components inheriting from CrestComponent can override GetComponentCssClass() to provide their base CSS classes and use the protected Visible property to control rendering.
    /// </summary>
    public class CrestComponent : ComponentBase, IDisposable
    {
        /// <summary>
        ...
        /// This allows setting a culture at the layout level that applies to all child Crest components.
        ...
        /// This allows setting a UI culture at the layout level that applies to all child Crest components.
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="CrestComponent"/> is visible. Invisible components are not rendered.
        /// </summary>
        ...
        private DotNetObjectReference<CrestComponent>? reference;

        /// <summary>
        /// Gets the reference for the current component.
        /// </summary>
        /// <value>The reference.</value>
        protected DotNetObjectReference<CrestComponent> Reference
        {
            get
            {
                if (reference == null)
        ...
        [JSInvokable("CrestComponent.RaiseContextMenu")]
        ...
        /// </summary>
        [JSInvokable("CrestComponent.RaiseMouseEnter")]
        ...
        /// </summary>
        [JSInvokable("CrestComponent.RaiseMouseLeave")]
