...
namespace Crest.Components.Primitives
{
    ...
    /// var activator = new CrestComponentActivator();
    /// // Replace CrestButton with MyButton
    /// activator.Override&lt;CrestButton, MyButton&gt;();
    /// // Replace CrestDataGrid with MyDataGrid
    /// activator.Override(typeof(CrestDataGrid&lt;&gt;), typeof(MyDataGrid&lt;&gt;));
    /// // Register the activator
    /// builder.Services.AddSingleton&lt;IComponentActivator&gt;(activator);
    /// </code>
    /// </example>
    public class CrestComponentActivator : IComponentActivator
    {
