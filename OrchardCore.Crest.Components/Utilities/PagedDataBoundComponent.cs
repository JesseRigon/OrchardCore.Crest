...
namespace Crest.Components.Primitives
{
    ...
    public class PagedDataBoundComponent<T> : CrestComponent
    {
        /// <summary>
...
#nullable restore
        ...
        [Parameter]
        public EventCallback<Crest.Components.Primitives.LoadDataArgs> LoadData { get; set; }
        ...
        public async virtual Task Reload()
        {
            ...
            await LoadData.InvokeAsync(new Crest.Components.Primitives.LoadDataArgs() { Skip = skip, Top = PageSize });
        ...
        /// The top pager
        /// </summary>
        protected CrestPager topPager = default!;
        /// <summary>
        /// The bottom pager
        /// </summary>
        protected CrestPager bottomPager = default!;
