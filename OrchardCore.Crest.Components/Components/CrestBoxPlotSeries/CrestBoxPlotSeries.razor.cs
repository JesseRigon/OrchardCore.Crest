...
{
    /// <summary>
    /// A chart series that displays statistical data as box-and-whisker plots in a CrestChart.
    ...
    public partial class CrestBoxPlotSeries<TItem> : CartesianSeries<TItem>
    {
        /// <summary>
