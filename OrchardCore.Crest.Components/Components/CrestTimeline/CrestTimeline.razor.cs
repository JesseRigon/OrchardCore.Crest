...
namespace Crest.Components.Primitives
{
    ...
    /// CrestTimeline presents events along a vertical or horizontal axis, ideal for histories, project milestones, or process flows.
    ...
    /// Timeline items are defined using CrestTimelineItem components. Common uses include order tracking, project progress, changelog displays, or activity feeds.
    /// </summary>
    /// <example>
    ...
    /// <code>
    /// &lt;CrestTimeline Orientation="Orientation.Horizontal" LinePosition="LinePosition.Bottom"&gt;
    ///     &lt;Items&gt;
    ///         &lt;CrestTimelineItem&gt;
    ...
    /// </code>
    /// </example>
    public partial class CrestTimeline : CrestComponent
    {
        /// <summary>
        /// Gets or sets the render fragment containing CrestTimelineItem components that define the timeline events.
        /// Each CrestTimelineItem represents one event or milestone in the timeline.
        /// </summary>
