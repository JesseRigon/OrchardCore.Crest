...
namespace Crest.Components.Primitives
{
    ...
    /// Connect to a <see cref="CrestChart" /> via two-way binding on <c>Start</c>/<c>End</c> and the chart's <c>ViewStart</c>/<c>ViewEnd</c>.
    /// </summary>
    public partial class CrestRangeNavigator : CrestComponent
    {
        /// <summary>
