...
{
    /// <summary>
    /// CrestDropZone component.
    /// </summary>
    public partial class CrestDropZone<TItem> : CrestComponentWithChildren
    {
        /// <summary>
        ...
        /// The Footer Template is rendered below the items in the <see cref="CrestDropZone{TItem}" />
        /// </summary>
        [Parameter]
        public RenderFragment? Footer { get; set; }

        [CascadingParameter]
        CrestDropZoneContainer<TItem>? Container { get; set; }
        ...
        Tuple<CrestDropZoneItemRenderEventArgs<TItem>, IReadOnlyDictionary<string, object>> ItemAttributes(TItem item)
        {
            var args = new CrestDropZoneItemRenderEventArgs<TItem>()
            {
                Zone = this,
                Item = item
            };
            ...
            return new Tuple<CrestDropZoneItemRenderEventArgs<TItem>, IReadOnlyDictionary<string, object>>(args, new ReadOnlyDictionary<string, object>(args.Attributes));
        }
    }
}
