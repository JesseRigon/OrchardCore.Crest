...
namespace Crest.Components.Primitives
{
    ...
    /// CrestUpload provides a full-featured file upload interface with automatic or manual upload, server communication, and comprehensive event handling.
    ...
    /// <code>
    /// &lt;CrestUpload Url="api/upload" Change=@OnChange Complete=@OnComplete /&gt;
    /// @code {
    ...
    /// <code>
    /// &lt;CrestUpload @ref=upload Url="api/upload" Auto="false" Multiple="true" Progress=@OnProgress /&gt;
    /// &lt;CrestButton Text="Upload" Click=@(() => upload.Upload()) /&gt;
    /// @code {
    ///     CrestUpload upload;
    ...
    /// <code>
    /// &lt;CrestUpload Url="api/upload/images" Accept="image/*" MaxFileSize="5000000" /&gt;
    /// </code>
    /// </example>
    public partial class CrestUpload : CrestComponent
    {
        ...
        [Parameter]
        public string ImageAlternateText { get => imageAlternateText ?? Localize(nameof(CrestStrings.Upload_ImageAlternateText)); set => imageAlternateText = value; }
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="CrestUpload"/> upload is automatic.
        /// </summary>
        ...
        [Parameter]
        public string ChooseText { get => chooseText ?? Localize(nameof(CrestStrings.Upload_ChooseText)); set => chooseText = value; }
        ...
        /// <value>The choose button text.</value>
        [Parameter]
        public string DeleteText { get => deleteText ?? Localize(nameof(CrestStrings.Upload_DeleteText)); set => deleteText = value; }
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="CrestUpload"/> is multiple.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="CrestUpload"/> is disabled.
        /// </summary>
        ...
        [JSInvokable("CrestUpload.OnChange")]
        ...
        [JSInvokable("CrestUpload.OnProgress")]
        ...
        [JSInvokable("CrestUpload.OnComplete")]
        ...
        [JSInvokable("CrestUpload.OnError")]
