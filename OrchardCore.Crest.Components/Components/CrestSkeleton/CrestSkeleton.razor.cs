...
namespace Crest.Components.Primitives
{
    ...
    /// CrestSkeleton provides subtle loading states that match content structure, improving perceived performance.
    ...
    /// Text line skeleton:
    /// <code>
    /// &lt;CrestSkeleton Style="width: 100%; height: 20px;" Animation="SkeletonAnimation.Pulse" /&gt;
    /// </code>
    /// Avatar and text skeleton:
    /// <code>
    /// &lt;CrestStack Orientation="Orientation.Horizontal" Gap="1rem" AlignItems="AlignItems.Center"&gt;
    ///     &lt;CrestSkeleton Variant="SkeletonVariant.Circle" Style="width: 50px; height: 50px;" /&gt;
    ///     &lt;CrestStack Gap="0.5rem"&gt;
    ///         &lt;CrestSkeleton Style="width: 200px; height: 16px;" /&gt;
    ///         &lt;CrestSkeleton Style="width: 150px; height: 16px;" /&gt;
    ///     &lt;/CrestStack&gt;
    /// &lt;/CrestStack&gt;
    /// </code>
    /// Image card skeleton:
    /// <code>
    /// &lt;CrestCard Style="width: 300px;"&gt;
    ///     &lt;CrestSkeleton Variant="SkeletonVariant.Rectangle" Style="width: 100%; height: 200px;" Animation="SkeletonAnimation.Wave" /&gt;
    ///     &lt;CrestSkeleton Style="width: 80%; height: 24px; margin-top: 1rem;" /&gt;
    ///     &lt;CrestSkeleton Style="width: 60%; height: 16px; margin-top: 0.5rem;" /&gt;
    /// &lt;/CrestCard&gt;
    /// </code>
    /// </example>
    public partial class CrestSkeleton : CrestComponent
    {
        /// <summary>
