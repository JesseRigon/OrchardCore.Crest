...
namespace Crest.Components.Primitives
{
    ...
    /// CrestDataGrid provides a full-featured table with inline editing, master-detail views, virtualization, export capabilities, and extensive customization options.
    ...
    /// Columns are defined using CrestDataGridColumn components within the Columns template.
    /// </summary>
    ...
    /// <code>
    /// &lt;CrestDataGrid Data=@orders TItem="Order" AllowSorting="true" AllowPaging="true" AllowFiltering="true" PageSize="10"&gt;
    ///     &lt;Columns&gt;
    ///         &lt;CrestDataGridColumn TItem="Order" Property="OrderId" Title="Order ID" /&gt;
    ///         &lt;CrestDataGridColumn TItem="Order" Property="OrderDate" Title="Order Date" FormatString="{0:d}" /&gt;
    ///         &lt;CrestDataGridColumn TItem="Order" Property="CustomerName" Title="Customer" /&gt;
    ///         &lt;CrestDataGridColumn TItem="Order" Property="Total" Title="Total" FormatString="{0:C}" /&gt;
    ///     &lt;/Columns&gt;
    /// &lt;/CrestDataGrid&gt;
    /// </code>
    /// Grid with inline editing:
    /// <code>
    /// &lt;CrestDataGrid @ref=grid Data=@orders TItem="Order" EditMode="DataGridEditMode.Single"&gt;
    ///     &lt;Columns&gt;
    ///         &lt;CrestDataGridColumn TItem="Order" Property="OrderId" Title="ID" Frozen="true"&gt;
    ///             &lt;EditTemplate Context="order"&gt;
    ///                 &lt;CrestNumeric @bind-Value="order.OrderId" Style="width:100%" /&gt;
    ///             &lt;/EditTemplate&gt;
    ///         &lt;/CrestDataGridColumn&gt;
    ///         &lt;CrestDataGridColumn TItem="Order" Context="order" Filterable="false" Sortable="false" TextAlign="TextAlign.Right"&gt;
    ///             &lt;Template Context="order"&gt;
    ///                 &lt;CrestButton Icon="edit" ButtonStyle="ButtonStyle.Light" Click="@(args =&gt; EditRow(order))" /&gt;
    ///             &lt;/Template&gt;
    ///             &lt;EditTemplate Context="order"&gt;
    ///                 &lt;CrestButton Icon="check" ButtonStyle="ButtonStyle.Success" Click="@(args =&gt; SaveRow(order))" /&gt;
    ///                 &lt;CrestButton Icon="close" ButtonStyle="ButtonStyle.Light" Click="@(args =&gt; CancelEdit(order))" /&gt;
    ///             &lt;/EditTemplate&gt;
    ///         &lt;/CrestDataGridColumn&gt;
    ///     &lt;/Columns&gt;
    /// &lt;/CrestDataGrid&gt;
    ...
    /// <code>
    /// &lt;CrestDataGrid Data=@orders TItem="Order" LoadData=@LoadData Count=@count IsLoading=@isLoading
    ///                 AllowSorting="true" AllowFiltering="true" AllowPaging="true" PageSize="20"&gt;
    ///     &lt;Columns&gt;
    ///         &lt;CrestDataGridColumn TItem="Order" Property="OrderId" Title="ID" /&gt;
    ///     &lt;/Columns&gt;
    /// &lt;/CrestDataGrid&gt;
    /// 
    /// @code {
    ...
    public partial class CrestDataGrid<TItem> : PagedDataBoundComponent<TItem> where TItem : notnull
    {
        ...
        RenderFragment DrawRows(IList<CrestDataGridColumn<TItem>> visibleColumns)
        {
                ...
                if (AllowVirtualization)
                {
                    if (AllowGrouping && Groups.Any() && !LoadData.HasDelegate)
                    {
                        ...
                        builder.AddAttribute(2, "ChildContent", (RenderFragment<GroupResult>)((context) =>
                        {
                            ...
                            {
                                b.OpenComponent(3, typeof(CrestDataGridGroupRow<TItem>));
                    ...
                    else
                    {
                        ...
                        builder.AddAttribute(2, "ChildContent", (RenderFragment<TItem>)((context) =>
                        {
                            return (RenderFragment)((b) =>
                            {
                                b.OpenComponent<CrestDataGridRow<TItem>>(3);
                                b.AddAttribute(4, "Columns", visibleColumns);
                                b.AddAttribute(5, "Grid", this);
                                ...
                                {
                                    b.AddAttribute(10, nameof(CrestDataGridRow<TItem>.EditContext), editContexts[context]);
                                }
        ...
        internal void DrawGroupOrDataRows(Microsoft.AspNetCore.Components.Rendering.RenderTreeBuilder builder, IList<CrestDataGridColumn<TItem>> visibleColumns)
        {
            if (Groups.Any())
            {
            ...
            else
            {
                ...
                {
                    builder.OpenComponent<CrestDataGridRow<TItem>>(0);
                    builder.AddAttribute(1, "Columns", visibleColumns);
                    ...
                    {
                        builder.AddAttribute(7, nameof(CrestDataGridRow<TItem>.EditContext), editContext);
                    }
        ...
        [Parameter]
        public EventCallback<Crest.Components.Primitives.DataGridLoadChildDataEventArgs<TItem>> LoadChildData { get; set; }
        ...
        [Parameter]
        public string? ExpandChildItemAriaLabel { get => expandChildItemAriaLabel ?? Localize(nameof(CrestStrings.DataGrid_ExpandChildItemAriaLabel)); set => expandChildItemAriaLabel = value; }
        ...
        [Parameter]
        public string? ExpandGroupAriaLabel { get => expandGroupAriaLabel ?? Localize(nameof(CrestStrings.DataGrid_ExpandGroupAriaLabel)); set => expandGroupAriaLabel = value; }
        ...
        [Parameter]
        public string? FilterToggleAriaLabel { get => filterToggleAriaLabel ?? Localize(nameof(CrestStrings.DataGrid_FilterToggleAriaLabel)); set => filterToggleAriaLabel = value; }
        ...
        internal string getFrozenColumnClass(CrestDataGridColumn<TItem> column, IList<CrestDataGridColumn<TItem>> visibleColumns)
        {
            if (!column.IsFrozen())
            {
                return "";
        ...
        internal string getColumnAlignClass(CrestDataGridColumn<TItem> column)
        {
        ...
        protected string DateFilterOperatorStyle(CrestDataGridColumn<TItem> column, FilterOperator value)
        {
        ...
        /// <param name="column">The column.</param>
        protected virtual void OnFilterKeyPress(EventArgs args, CrestDataGridColumn<TItem> column)
        {
            if (FilterAsYouType)
            {
        ...
        EventCallback<KeyboardEventArgs> getFilterKeyDownHandler(CrestDataGridColumn<TItem> column)
        {
        ...
        async Task DebounceFilter(CrestDataGridColumn<TItem> column)
        {
            if (JSRuntime != null)
            {
...
#pragma warning restore CS4014 // Because this call is not awaited, execution of the current method continues before the call is completed
        ...
        protected void ApplyDateFilterByFilterOperator(CrestDataGridColumn<TItem> column, FilterOperator filterOperator)
        {
            ArgumentNullException.ThrowIfNull(column);
        ...
        private List<CrestDataGridColumn<TItem>> columns = new List<CrestDataGridColumn<TItem>>();
        internal readonly List<CrestDataGridColumn<TItem>> childColumns = new List<CrestDataGridColumn<TItem>>();
        internal List<CrestDataGridColumn<TItem>> allColumns = new List<CrestDataGridColumn<TItem>>();
        private List<CrestDataGridColumn<TItem>> allPickableColumns = new List<CrestDataGridColumn<TItem>>();
        ...
        CrestDropDownDataGrid<object>? columnPickerGrid;
        ...
        internal void AddColumn(CrestDataGridColumn<TItem> column)
        {
        ...
        internal void UpdatePickableColumn(CrestDataGridColumn<TItem> column, bool visible)
        {
        ...
        internal void RemoveColumn(CrestDataGridColumn<TItem> column)
        {
        ...
        async Task ToggleColumns()
        {
            if (selectedColumns == null)
            {
                selectedColumns = Array.Empty<CrestDataGridColumn<TItem>>();
            }

            var selected = ((IEnumerable<object>)selectedColumns).Cast<CrestDataGridColumn<TItem>>();
        ...
        internal string getFilterInputId(CrestDataGridColumn<TItem> column)
        {
            return string.Join("", $"{UniqueID}".Split('.')) + column.GetFilterProperty();
        }

        internal string getFilterDateFormat(CrestDataGridColumn<TItem> column)
        {
        ...
        internal RenderFragment DrawNumericFilter(CrestDataGridColumn<TItem> column, bool force = true, bool isFirst = true)
        {
            return new RenderFragment(builder =>
            {
                ...
                var numericType = typeof(CrestNumeric<>).MakeGenericType(type);
        ...
        protected virtual async Task OnFilter(ChangeEventArgs args, CrestDataGridColumn<TItem> column, bool force = false, bool isFirst = true)
        {
            ArgumentNullException.ThrowIfNull(args);
            ArgumentNullException.ThrowIfNull(column);
        ...
        public IList<CrestDataGridColumn<TItem>> ColumnsCollection
        {
            get
            {
                return columns;
        ...
        internal async Task OnSort(EventArgs args, CrestDataGridColumn<TItem> column)
        {
        ...
        /// </summary>
        public async Task ClearFilter(CrestDataGridColumn<TItem> column, bool closePopup = false, bool shouldReload = true)
        {
            ArgumentNullException.ThrowIfNull(column);
            if (closePopup)
            {
        ...
        /// </summary>
        public async Task ApplyFilter(CrestDataGridColumn<TItem> column, bool closePopup = false)
        {
            ArgumentNullException.ThrowIfNull(column);
            if (closePopup)
            {
        ...
        internal IReadOnlyDictionary<string, object> CellAttributes(TItem item, CrestDataGridColumn<TItem> column)
        {
            var args = new Crest.Components.Primitives.DataGridCellRenderEventArgs<TItem>() { Data = item, Column = column };
        ...
        internal IReadOnlyDictionary<string, object> HeaderCellAttributes(CrestDataGridColumn<TItem> column)
        {
            var args = new Crest.Components.Primitives.DataGridCellRenderEventArgs<TItem>() { Column = column };
        ...
        internal IReadOnlyDictionary<string, object> FooterCellAttributes(CrestDataGridColumn<TItem> column)
        {
            var args = new Crest.Components.Primitives.DataGridCellRenderEventArgs<TItem>() { Column = column };
        ...
        [Parameter]
        public string FilterText { get => filterText ?? Localize(nameof(CrestStrings.DataGrid_FilterText)); set => filterText = value; }
        ...
        [Parameter]
        public string EnumFilterSelectText { get => enumFilterSelectText ?? Localize(nameof(CrestStrings.DataGrid_EnumFilterSelectText)); set => enumFilterSelectText = value; }
        ...
        /// <value>The enum filter select text.</value>
        [Parameter]
        public string EnumNullFilterText { get => enumNullFilterText ?? Localize(nameof(CrestStrings.DataGrid_EnumNullFilterText)); set => enumNullFilterText = value; }
        ...
        [Parameter]
        public string AndOperatorText { get => andOperatorText ?? Localize(nameof(CrestStrings.DataGrid_AndOperatorText)); set => andOperatorText = value; }
        ...
        [Parameter]
        public string OrOperatorText { get => orOperatorText ?? Localize(nameof(CrestStrings.DataGrid_OrOperatorText)); set => orOperatorText = value; }
        ...
        [Parameter]
        public string ApplyFilterText { get => applyFilterText ?? Localize(nameof(CrestStrings.DataGrid_ApplyFilterText)); set => applyFilterText = value; }
        ...
        [Parameter]
        public string ClearFilterText { get => clearFilterText ?? Localize(nameof(CrestStrings.DataGrid_ClearFilterText)); set => clearFilterText = value; }
        ...
        [Parameter]
        public string EqualsText { get => equalsText ?? Localize(nameof(CrestStrings.DataGrid_EqualsText)); set => equalsText = value; }
        ...
        [Parameter]
        public string NotEqualsText { get => notEqualsText ?? Localize(nameof(CrestStrings.DataGrid_NotEqualsText)); set => notEqualsText = value; }
        ...
        [Parameter]
        public string LessThanText { get => lessThanText ?? Localize(nameof(CrestStrings.DataGrid_LessThanText)); set => lessThanText = value; }
        ...
        [Parameter]
        public string LessThanOrEqualsText { get => lessThanOrEqualsText ?? Localize(nameof(CrestStrings.DataGrid_LessThanOrEqualsText)); set => lessThanOrEqualsText = value; }
        ...
        [Parameter]
        public string GreaterThanText { get => greaterThanText ?? Localize(nameof(CrestStrings.DataGrid_GreaterThanText)); set => greaterThanText = value; }
        ...
        [Parameter]
        public string GreaterThanOrEqualsText { get => greaterThanOrEqualsText ?? Localize(nameof(CrestStrings.DataGrid_GreaterThanOrEqualsText)); set => greaterThanOrEqualsText = value; }
        ...
        [Parameter]
        public string EndsWithText { get => endsWithText ?? Localize(nameof(CrestStrings.DataGrid_EndsWithText)); set => endsWithText = value; }
        ...
        [Parameter]
        public string ContainsText { get => containsText ?? Localize(nameof(CrestStrings.DataGrid_ContainsText)); set => containsText = value; }
        ...
        [Parameter]
        public string DoesNotContainText { get => doesNotContainText ?? Localize(nameof(CrestStrings.DataGrid_DoesNotContainText)); set => doesNotContainText = value; }
        ...
        [Parameter]
        public string InText { get => inText ?? Localize(nameof(CrestStrings.DataGrid_InText)); set => inText = value; }
        ...
        [Parameter]
        public string NotInText { get => notInText ?? Localize(nameof(CrestStrings.DataGrid_NotInText)); set => notInText = value; }
        ...
        [Parameter]
        public string StartsWithText { get => startsWithText ?? Localize(nameof(CrestStrings.DataGrid_StartsWithText)); set => startsWithText = value; }
        ...
        [Parameter]
        public string IsNotNullText { get => isNotNullText ?? Localize(nameof(CrestStrings.DataGrid_IsNotNullText)); set => isNotNullText = value; }
        ...
        [Parameter]
        public string IsNullText { get => isNullText ?? Localize(nameof(CrestStrings.DataGrid_IsNullText)); set => isNullText = value; }
        ...
        [Parameter]
        public string IsEmptyText { get => isEmptyText ?? Localize(nameof(CrestStrings.DataGrid_IsEmptyText)); set => isEmptyText = value; }
        ...
        [Parameter]
        public string IsNotEmptyText { get => isNotEmptyText ?? Localize(nameof(CrestStrings.DataGrid_IsNotEmptyText)); set => isNotEmptyText = value; }
        ...
        [Parameter]
        public string CustomText { get => customText ?? Localize(nameof(CrestStrings.DataGrid_CustomText)); set => customText = value; }
        ...
        {
            get { return emptyText ?? Localize(nameof(CrestStrings.DataGrid_EmptyText)); }
            set { emptyText = value; }
        }
        ...
        [Parameter]
        public string ColumnsShowingText { get => columnsShowingText ?? Localize(nameof(CrestStrings.DataGrid_ColumnsShowingText)); set => columnsShowingText = value; }
        ...
        [Parameter]
        public string AllColumnsText { get => allColumnsText ?? Localize(nameof(CrestStrings.DataGrid_AllColumnsText)); set => allColumnsText = value; }
        ...
        [Parameter]
        public string ColumnsText { get => columnsText ?? Localize(nameof(CrestStrings.DataGrid_ColumnsText)); set => columnsText = value; }
        ...
        [Parameter]
        public string RemoveGroupAriaLabel { get => removeGroupAriaLabel ?? Localize(nameof(CrestStrings.DataGrid_RemoveGroupAriaLabel)); set => removeGroupAriaLabel = value; }
        ...
        [Parameter]
        public string SelectVisibleColumnsAriaLabel { get => selectVisibleColumnsAriaLabel ?? Localize(nameof(CrestStrings.DataGrid_SelectVisibleColumnsAriaLabel)); set => selectVisibleColumnsAriaLabel = value; }
        ...
        [Parameter]
        public string LogicalOperatorAriaLabel { get => logicalOperatorAriaLabel ?? Localize(nameof(CrestStrings.DataGrid_LogicalOperatorAriaLabel)); set => logicalOperatorAriaLabel = value; }
        ...
        [Parameter]
        public string FilterOperatorAriaLabel { get => filterOperatorAriaLabel ?? Localize(nameof(CrestStrings.DataGrid_FilterOperatorAriaLabel)); set => filterOperatorAriaLabel = value; }
        ...
        /// <value>The the column filter value aria label text.</value>
        [Parameter]
        public string SecondFilterOperatorAriaLabel { get => secondFilterOperatorAriaLabel ?? Localize(nameof(CrestStrings.DataGrid_SecondFilterOperatorAriaLabel)); set => secondFilterOperatorAriaLabel = value; }
        ...
        /// <value>The the column filter value aria label text.</value>
        [Parameter]
        public string FilterValueAriaLabel { get => filterValueAriaLabel ?? Localize(nameof(CrestStrings.DataGrid_FilterValueAriaLabel)); set => filterValueAriaLabel = value; }
        ...
        /// <value>The the column filter value aria label text.</value>
        [Parameter]
        public string SecondFilterValueAriaLabel { get => secondFilterValueAriaLabel ?? Localize(nameof(CrestStrings.DataGrid_SecondFilterValueAriaLabel)); set => secondFilterValueAriaLabel = value; }
        ...
        [Parameter]
        public RenderFragment<(Group Group, CrestDataGridGroupRow<TItem> GroupHeader)>? GroupHeaderToggleTemplate { get; set; }
        ...
        [Parameter]
        public string GroupPanelText { get => groupPanelText ?? Localize(nameof(CrestStrings.DataGrid_GroupPanelText)); set => groupPanelText = value; }
        ...
        [JSInvokable("CrestGrid.OnColumnReorderEnded")]
        ...
        /// </summary>
        [JSInvokable("CrestGrid.OnColumnDropToGroup")]
        ...
        /// <param name="value">The value.</param>
        [JSInvokable("CrestGrid.OnColumnResized")]
        ...
        internal static string GetSortOrderAsString(SortDescriptor d, bool isOData)
        {
            ...
            return $"{p} {(d.SortOrder == Crest.Components.Primitives.SortOrder.Ascending ? "asc" : "desc")}";
        }
        ...
        CrestDataGridColumn<TItem>? SortColumn(SortDescriptor descriptor) =>
        ...
        internal async Task InvokeLoadData(int start, int top)
        {
            ...
            if (LoadData.HasDelegate)
            {
                await LoadData.InvokeAsync(new Crest.Components.Primitives.LoadDataArgs()
                {
                    Skip = start,
                    Top = top,
                    OrderBy = orderBy,
        ...
        internal Dictionary<CrestDataGridGroupRow<TItem>, bool> collapsedGroupItems = new Dictionary<CrestDataGridGroupRow<TItem>, bool>();

        internal string ExpandedGroupItemStyle(CrestDataGridGroupRow<TItem> item, bool? expandedOnLoad)
        {
        ...
        internal bool IsGroupItemExpanded(CrestDataGridGroupRow<TItem> item)
        {
        ...
        /// Expand group item.
        /// </summary>
        public async System.Threading.Tasks.Task ExpandGroupItem(CrestDataGridGroupRow<TItem> item, bool? expandedOnLoad)
        {
        ...
        internal Tuple<Crest.Components.Primitives.RowRenderEventArgs<TItem>, IReadOnlyDictionary<string, object>> RowAttributes(TItem item, int index)
        {
            var args = new Crest.Components.Primitives.RowRenderEventArgs<TItem>() { Data = item, Index = index, Expandable = Template != null || LoadChildData.HasDelegate };
            ...
            return new Tuple<Crest.Components.Primitives.RowRenderEventArgs<TItem>, IReadOnlyDictionary<string, object>>(args, new System.Collections.ObjectModel.ReadOnlyDictionary<string, object>(args.Attributes));
        }

        internal Tuple<GroupRowRenderEventArgs, IReadOnlyDictionary<string, object>> GroupRowAttributes(CrestDataGridGroupRow<TItem> item)
        {
            var args = new Crest.Components.Primitives.GroupRowRenderEventArgs() { Group = item.Group, FirstRender = firstRender, Expandable = item.GroupResult.Count > 0 };
        ...
        protected override async Task OnAfterRenderAsync(bool firstRender)
        {
            ...
            {
                var args = new Crest.Components.Primitives.DataGridLoadSettingsEventArgs() { Settings = settings };
            ...
            if (Visible)
            {
                ...
                if (Render != null)
                {
                    Render(new Crest.Components.Primitives.DataGridRenderEventArgs<TItem>() { Grid = this, FirstRender = firstRender });
                }

                if (RenderAsync != null)
                {
                    await RenderAsync(new Crest.Components.Primitives.DataGridRenderEventArgs<TItem>() { Grid = this, FirstRender = firstRender });
                }
            }
        ...
        [Parameter]
        public string ExpandAllTitle { get => expandAllTitle ?? Localize(nameof(CrestStrings.DataGrid_ExpandAllTitle)); set => expandAllTitle = value; }
        ...
        [Parameter]
        public string CollapseAllTitle { get => collapseAllTitle ?? Localize(nameof(CrestStrings.DataGrid_CollapseAllTitle)); set => collapseAllTitle = value; }
        ...
        internal static bool ShowGridLines(CrestDataGridColumn<TItem> column)
        {
        ...
        internal string getCompositeCellCSSClass(CrestDataGridColumn<TItem> column)
        {
        ...
        internal void SetNextColumnSortOrder(CrestDataGridColumn<TItem> column)
        {
        ...
        private void SetColumnSortOrder(CrestDataGridColumn<TItem> column, SortOrder? sortOrder)
        {
        ...
        List<CrestDataGridColumn<TItem>> groupedColumns = new List<CrestDataGridColumn<TItem>>();
        /// <summary>
        ...
        public virtual bool SetColumnFilterValueFromSettings(CrestDataGridColumn<TItem> gridColumn, DataGridColumnSettings columnSettings, bool isFirst)
        {
