...
/// <summary>
/// Supplies information about a <see cref="Crest.Components.Primitives.CrestDataGrid{TItem}.LoadColumnFilterData" /> event that is being raised.
/// </summary>
...
public class DataGridLoadColumnFilterDataEventArgs<T> where T : notnull
{
    ...
    /// <summary>
    /// Gets the CrestDataGridColumn.
    /// </summary>
    public Crest.Components.Primitives.CrestDataGridColumn<T>? Column { get; internal set; }
}
