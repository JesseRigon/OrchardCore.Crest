...
{
    /// <summary>
    /// Gets or sets the group row HTML attributes. They will apply to the table row (tr) element which CrestDataGrid renders for every group row.
    /// </summary>
    ...
    /// <summary>
    /// Gets a value indicating whether this is the first time the CrestGrid has rendered.
    /// </summary>
