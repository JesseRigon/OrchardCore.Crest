...
{
    /// <summary>
    /// A flexbox row container component that horizontally arranges CrestColumn components in a responsive 12-column grid layout.
    /// CrestRow provides gap spacing, alignment, and justification controls for creating flexible, responsive page layouts.
    /// Serves as a container for CrestColumn components, creating a horizontal flexbox layout where columns automatically wrap to the next line when their combined Size values exceed 12.
    ...
    /// JustifyContent for horizontal distribution (start, center, end, space-between, space-around), and works seamlessly with CrestColumn's breakpoint-specific sizing.
    /// Use AlignItems and JustifyContent from the base CrestFlexComponent to control layout behavior.
    /// </summary>
    /// <example>
    /// Basic row with columns and gap:
    /// <code>
    /// &lt;CrestRow Gap="1rem"&gt;
    ///     &lt;CrestColumn Size="4"&gt;Column 1&lt;/CrestColumn&gt;
    ///     &lt;CrestColumn Size="4"&gt;Column 2&lt;/CrestColumn&gt;
    ///     &lt;CrestColumn Size="4"&gt;Column 3&lt;/CrestColumn&gt;
    /// &lt;/CrestRow&gt;
    /// </code>
    /// Row with alignment and justification:
    /// <code>
    /// &lt;CrestRow AlignItems="AlignItems.Center" JustifyContent="JustifyContent.SpaceBetween" Gap="2rem"&gt;
    ///     &lt;CrestColumn Size="3"&gt;Left&lt;/CrestColumn&gt;
    ///     &lt;CrestColumn Size="3"&gt;Right&lt;/CrestColumn&gt;
    /// &lt;/CrestRow&gt;
    /// </code>
    /// </example>
    public partial class CrestRow : CrestFlexComponent
    {
        /// <summary>
