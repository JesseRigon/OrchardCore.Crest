...
namespace Crest.Components.Primitives
{
    ...
    /// <code>
    /// &lt;CrestChart&gt;
    ///     &lt;CrestContourSeries Data=@grid CategoryProperty="X" ValueProperty="Y" IntensityProperty="Lux"
    ...
    public partial class CrestContourSeries<TItem> : CartesianSeries<TItem>
    {
        /// <summary>
        ...
        /// </summary>
        [Parameter]
        public string IntensityLabel { get => intensityLabel ?? Chart?.Localize(nameof(CrestStrings.ContourSeries_IntensityLabel)) ?? "Value"; set => intensityLabel = value; }
