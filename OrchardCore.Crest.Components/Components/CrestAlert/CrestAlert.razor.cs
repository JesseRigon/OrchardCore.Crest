...
namespace Crest.Components.Primitives
{
    ...
    /// CrestAlert provides contextual feedback messages for Success, Info, Warning, Error, and other notification scenarios.
    ...
    /// Basic success alert:
    /// <code>
    /// &lt;CrestAlert AlertStyle="AlertStyle.Success" Title="Success!" Text="Operation completed successfully." /&gt;
    /// </code>
    /// Warning alert with custom content:
    /// <code>
    /// &lt;CrestAlert AlertStyle="AlertStyle.Warning" AllowClose="false" ShowIcon="true"&gt;
    ...
    /// @if (showAlert)
    /// {
    ///     &lt;CrestAlert AlertStyle="AlertStyle.Info" Variant="Variant.Flat" 
    ...
    /// </code>
    /// </example>
    public partial class CrestAlert : CrestComponentWithChildren
    {
        ...
        [Parameter]
        public string CloseAriaLabel { get => closeAriaLabel ?? Localize(nameof(CrestStrings.Alert_CloseAriaLabel)); set => closeAriaLabel = value; }
