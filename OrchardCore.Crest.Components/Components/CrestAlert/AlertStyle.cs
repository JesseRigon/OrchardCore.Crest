...
/// <summary>
/// Specifies the display style or severity of a <see cref="Crest.Components.Primitives.CrestAlert" />. Affects the visual styling of CrestAlert (background and text color).
/// </summary>
