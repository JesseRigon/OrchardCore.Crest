...
namespace Crest.Components.Primitives
{
    ...
    /// To use this service, add it as a scoped service in your application's service collection and place a CrestTooltip component in your main layout.
    ...
    /// &lt;CrestButton Text="Hover me" MouseEnter="@(args =&gt; TooltipService.Open(args, "This is a tooltip"))" /&gt;
    /// </code>
    /// Show a tooltip with HTML content and custom options:
    /// <code>
    /// @inject TooltipService TooltipService
    /// &lt;CrestButton Text="Show tooltip" MouseEnter="@(args =&gt; ShowTooltipWithHtml(args))" /&gt;
    /// @code {
    ...
    public class Tooltip
    {
        ...
        public TooltipOptions Options { get; set; } = new TooltipOptions();
        /// <summary>
