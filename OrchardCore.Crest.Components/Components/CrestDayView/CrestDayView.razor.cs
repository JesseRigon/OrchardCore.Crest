...
{
    /// <summary>
    /// Displays the appointments in a single day in <see cref="CrestScheduler{TItem}" />
    /// </summary>
    /// <example>
    /// <code>
    ...
    /// </code>
    /// </example>
    public partial class CrestDayView : SchedulerViewBase
    {
        /// <inheritdoc />
        ...
        /// <inheritdoc />
        [Parameter]
        public override string Text { get => text ?? Localize(nameof(CrestStrings.DayView_Text)); set => text = value; }
        private string? text;
