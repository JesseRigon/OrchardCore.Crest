...
{
    /// <summary>
    /// CrestPivotColumn component. Must be placed inside a <see cref="CrestPivotDataGrid{TItem}" />
    /// </summary>
    /// <typeparam name="TItem">The type of the PivotDataGrid item.</typeparam>
    public partial class CrestPivotColumn<TItem> : CrestPivotField<TItem>, IDisposable
    {
        /// <summary>
        ...
        /// Set to <c>null</c> by default - the localized <see cref="CrestPivotDataGrid{TItem}.OthersText"/> of the parent pivot grid is used.
        /// </summary>
        [Parameter]
