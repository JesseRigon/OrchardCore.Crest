...
{
    /// <summary>
    /// A tool which inserts and uploads images in a <see cref="CrestHtmlEditor" />.
    /// </summary>
    /// <example>
    /// <code>
    ...
    /// </code>
    /// </example>
    public partial class CrestHtmlEditorImage : CrestHtmlEditorButtonBase
    {
        ...
        /// </summary>
        [Parameter]
        public string Title { get => title ?? Localize(nameof(CrestStrings.HtmlEditorImage_Title)); set => title = value; }
        ...
        /// </summary>
        [Parameter]
        public string SelectText { get => selectText ?? Localize(nameof(CrestStrings.HtmlEditorImage_SelectText)); set => selectText = value; }
        ...
        /// </summary>
        [Parameter]
        public string UploadChooseText { get => uploadChooseText ?? Localize(nameof(CrestStrings.HtmlEditorImage_UploadChooseText)); set => uploadChooseText = value; }
        ...
        /// </summary>
        [Parameter]
        public string UrlText { get => urlText ?? Localize(nameof(CrestStrings.HtmlEditorImage_UrlText)); set => urlText = value; }
        ...
        /// </summary>
        [Parameter]
        public string AltText { get => altText ?? Localize(nameof(CrestStrings.HtmlEditorImage_AltText)); set => altText = value; }
        ...
        /// </summary>
        [Parameter]
        public string OkText { get => okText ?? Localize(nameof(CrestStrings.HtmlEditorImage_OkText)); set => okText = value; }
        ...
        /// </summary>
        [Parameter]
        public string CancelText { get => cancelText ?? Localize(nameof(CrestStrings.HtmlEditorImage_CancelText)); set => cancelText = value; }
        ...
        /// </summary>
        [Parameter]
        public string WidthText { get => widthText ?? Localize(nameof(CrestStrings.HtmlEditorImage_WidthText)); set => widthText = value; }
        ...
        /// </summary>
        [Parameter]
        public string HeightText { get => heightText ?? Localize(nameof(CrestStrings.HtmlEditorImage_HeightText)); set => heightText = value; }
        ...
        CrestUpload? FileUpload { get; set; }
