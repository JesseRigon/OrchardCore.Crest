...
{
    /// <summary>
    /// Defines a column in a CrestDataGrid, specifying how data is displayed, sorted, filtered, and edited.
    /// CrestDataGridColumn supports data binding via Property, custom templates, formatting, sorting, filtering, grouping, aggregation, and inline editing.
    /// Must be placed inside a <see cref="CrestDataGrid{TItem}"/> within the Columns template.
    ...
    /// <code>
    /// &lt;CrestDataGridColumn TItem="Order" Property="OrderDate" Title="Date" FormatString="{0:d}" Width="120px" /&gt;
    /// </code>
    /// Column with custom template:
    /// <code>
    /// &lt;CrestDataGridColumn TItem="Order" Title="Actions" Sortable="false" Filterable="false"&gt;
    ///     &lt;Template Context="order"&gt;
    ///         &lt;CrestButton Icon="edit" Click="@(args =&gt; EditOrder(order))" /&gt;
    ///         &lt;CrestButton Icon="delete" Click="@(args =&gt; DeleteOrder(order))" /&gt;
    ///     &lt;/Template&gt;
    /// &lt;/CrestDataGridColumn&gt;
    /// </code>
    /// </example>
    ...
    public partial class CrestDataGridColumn<TItem> : ComponentBase, IDisposable where TItem : notnull
    {
        /// <summary>
        /// Gets or sets the parent CrestDataGrid that contains this column.
        ...
        [CascadingParameter]
        public CrestDataGridColumn<TItem>? Parent { get; set; }
        ...
        {
            if (Grid.childColumns.Remove(column))
            {
                if (!Grid.disposed)
                {
        ...
        internal IEnumerable<CrestDataGridColumn<TItem>> VisibleColumns => ColumnsCollection.Where(c => c.GetVisible());
        ...
        {
            var canSetFilterPropertyType = (FilterMode ?? Grid.FilterMode) == Crest.Components.Primitives.FilterMode.CheckBoxList && FilterTemplate == null;
        ...
        /// <summary>
        /// Gets or sets the sequence of the <see cref="Crest.Components.Primitives.SortOrder"/>s to use when sorting the column interactively.
        /// </summary>
        [Parameter]
        public SortOrder?[] SortOrderSequence { get; set; } = [Crest.Components.Primitives.SortOrder.Ascending, Crest.Components.Primitives.SortOrder.Descending, null];

        bool visible = true;
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="CrestDataGridColumn{TItem}"/> is visible.
        /// </summary>
        ...
        [Parameter]
        public Func<CrestDataGridColumn<TItem>, TItem, string>? CalculatedCssClass { get; set; }
        ...
        [Parameter]
        public string GroupFooterCssClass { get; set; } = string.Empty;
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="CrestDataGridColumn{TItem}"/> is filterable.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="CrestDataGridColumn{TItem}"/> is sortable.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="CrestDataGridColumn{TItem}"/> is frozen.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the frozen position this <see cref="CrestDataGridColumn{TItem}"/>
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="CrestDataGridColumn{TItem}"/> is resizable.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="CrestDataGridColumn{TItem}"/> is reorderable.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="CrestDataGridColumn{TItem}"/> is groupable.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="CrestDataGridColumn{TItem}"/> is pickable - listed when DataGrid AllowColumnPicking is set to true.
        /// </summary>
        ...
        [Parameter]
        public RenderFragment<CrestDataGridColumn<TItem>>? FilterTemplate { get; set; }
        ...
        [Parameter]
        public RenderFragment<CrestDataGridColumn<TItem>>? FilterValueTemplate { get; set; }
        ...
        [Parameter]
        public RenderFragment<CrestDataGridColumn<TItem>>? SecondFilterValueTemplate { get; set; }
        ...
        public virtual object? GetValue(TItem item)
        {
            ...
            if (FilterPropertyType != null && (PropertyAccess.IsEnum(FilterPropertyType) || PropertyAccess.IsNullableEnum(FilterPropertyType) ||
                ((FilterMode ?? Grid.FilterMode) == Crest.Components.Primitives.FilterMode.CheckBoxList && (value as Enum) != null)) && value != null)
            {
        ...
        private static string GetStackedStyleForFrozen(IEnumerable<CrestDataGridColumn<TItem>> stackColumns, string position)
        {
            if (!stackColumns.Any())
            {
                return $"{position}:0";
            ...
            foreach (var column in stackColumns)
            {
                ...
                if (w.StartsWith("calc(", StringComparison.Ordinal) && w.EndsWith(')'))
                {
        ...
        {
            var enumName = Enum.GetName<WhiteSpace>(HeaderWhiteSpace);
            return $"rz-column-title-content rz-text-{(enumName ?? HeaderWhiteSpace.ToString()).ToLower(CultureInfo.InvariantCulture)}";
        }
        ...
        public void SetFilterValue(object? value, bool isFirst = true)
        {
            ...
            if ((FilterPropertyType == typeof(DateOnly) || FilterPropertyType == typeof(DateOnly?)) && value != null && value is DateTime?)
            {
            ...
            {
                var v = TimeOnly.Parse($"{value}", CultureInfo.InvariantCulture);
            ...
            if (!QueryableExtension.IsEnumerable(value?.GetType() ?? typeof(object)) && FilterPropertyType != null && (PropertyAccess.IsEnum(FilterPropertyType) || (PropertyAccess.IsNullableEnum(FilterPropertyType))))
            {
        ...
        internal string GetColumnPopupID()
        {
            ...
            return $"{Grid.PopupID}{(string.IsNullOrEmpty(fiterProperty) ? Grid.allColumns.IndexOf(this).ToString(CultureInfo.InvariantCulture) : fiterProperty)}";
        }
        ...
        internal CrestDataGridHeaderCell<TItem>? headerCell;
    }
}
