...
{
    /// <summary>
    /// A chart series that displays a filled area between two value lines in a CrestChart.
    ...
    /// <code>
    /// &lt;CrestChart&gt;
    ///     &lt;CrestRangeAreaSeries Data=@data CategoryProperty="Month"
    ///         MinProperty="Low" MaxProperty="High" Title="Temperature Range" /&gt;
    /// &lt;/CrestChart&gt;
    /// </code>
    /// </example>
    [UnconditionalSuppressMessage(TrimMessages.Trimming, TrimMessages.IL2026, Justification = TrimMessages.DataTypePreserved)]
    public partial class CrestRangeAreaSeries<TItem> : CartesianSeries<TItem>
    {
        /// <summary>
