...
namespace Crest.Components.Primitives
{
    ...
    /// CrestFileInput provides client-side file reading without server upload, ideal for form fields or immediate file processing.
    /// Unlike CrestUpload which sends files to a server, FileInput reads files on the client and binds the content to a property.
    ...
    /// <code>
    /// &lt;CrestFileInput @bind-Value=@model.PhotoData TValue="string" /&gt;
    /// @code {
    ///     class Employee
    ///     {
    ...
    /// <code>
    /// &lt;CrestFileInput @bind-Value=@fileContent TValue="byte[]" Accept="image/*" MaxFileSize="2000000" /&gt;
    /// @code {
    ///     byte[] fileContent;
    /// }
    /// </code>
    /// </example>
    public partial class CrestFileInput<TValue> : FormComponent<TValue>
    {
        ...
        [Parameter]
        public string ChooseText { get => chooseText ?? Localize(nameof(CrestStrings.FileInput_ChooseText)); set => chooseText = value; }
        ...
        [Parameter]
        public string DeleteText { get => deleteText ?? Localize(nameof(CrestStrings.FileInput_DeleteText)); set => deleteText = value; }
        ...
        [Parameter]
        public string ImageAlternateText { get => imageAlternateText ?? Localize(nameof(CrestStrings.FileInput_ImageAlternateText)); set => imageAlternateText = value; }
