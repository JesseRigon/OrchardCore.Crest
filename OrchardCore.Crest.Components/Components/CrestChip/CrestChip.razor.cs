...
namespace Crest.Components.Primitives
{
    ...
    /// </summary>
    public partial class CrestChip : CrestComponent
    {
        /// <inheritdoc />
        ...
        /// </summary>
        [Parameter]
        public string RemoveChipTitle { get => removeChipTitle ?? Localize(nameof(CrestStrings.Chip_RemoveChipTitle)); set => removeChipTitle = value; }
