...
{
    /// <summary>
    /// A dashboard layout that arranges <see cref="CrestTileLayoutItem" /> tiles on a configurable
    ...
    /// <example>
    /// <code>
    /// &lt;CrestTileLayout Columns="12" RowHeight="80" EditMode="true" ShowGrid="true" Change=@OnChange&gt;
    ///     &lt;CrestTileLayoutItem Title="Sales" Col="1" Row="1" ColSpan="6" RowSpan="2"&gt;
    ///         ...
    ///     &lt;/CrestTileLayoutItem&gt;
    ///     &lt;CrestTileLayoutItem Title="Visitors" Col="7" Row="1" ColSpan="6" RowSpan="2"&gt;
    ///         ...
    ///     &lt;/CrestTileLayoutItem&gt;
    /// &lt;/CrestTileLayout&gt;
    /// </code>
    /// </example>
    public partial class CrestTileLayout : CrestComponent
    {
        /// <summary>
        /// Gets or sets the tiles to display. Should contain <see cref="CrestTileLayoutItem" /> components.
        /// </summary>
        ...
        [Parameter]
        public EventCallback<CrestTileLayoutItem> Change { get; set; }

        private readonly List<CrestTileLayoutItem> items = new();

        private ElementReference cellsElement;

        private CrestTileLayoutItem? activeItem;
        ...
        internal void AddItem(CrestTileLayoutItem item)
        {
        ...
        internal void RemoveItem(CrestTileLayoutItem item)
        {
        ...
        internal Task StartMove(CrestTileLayoutItem item, PointerEventArgs args)
        {
            return StartDrag(item, args, false);
        }

        internal Task StartResize(CrestTileLayoutItem item, PointerEventArgs args)
        {
            return StartDrag(item, args, true);
        }

        private async Task StartDrag(CrestTileLayoutItem item, PointerEventArgs args, bool isResize)
        {
            if (JSRuntime == null)
            {
                return;
