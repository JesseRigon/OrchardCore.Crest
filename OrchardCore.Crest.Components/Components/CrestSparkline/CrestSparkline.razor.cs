...
namespace Crest.Components.Primitives
{
    ...
    /// </summary>
    public partial class CrestSparkline : CrestChart
    {
        /// <summary>
        /// Instantiates a new instance of <see cref="CrestSparkline" />.
        /// </summary>
        public CrestSparkline()
        {
            CategoryAxis = new CrestCategoryAxis { Visible = false };
            ValueAxis = new CrestValueAxis { Visible = false };
            Legend = new CrestLegend { Visible = false };
            TooltipTolerance = 5;
        }
