...
namespace Crest.Components.Primitives
{
    ...
    /// CrestScheduler provides a rich calendar interface with drag-and-drop, inline editing, recurring events, and customizable views.
    ...
    /// Define data properties using StartProperty, EndProperty, and TextProperty. Add view components (CrestDayView, CrestWeekView, CrestMonthView) as child content.
    /// </summary>
    ...
    /// <code>
    /// &lt;CrestScheduler Data=@appointments TItem="Appointment" StartProperty="Start" EndProperty="End" TextProperty="Title"&gt;
    ///     &lt;CrestMonthView /&gt;
    ///     &lt;CrestWeekView /&gt;
    ///     &lt;CrestDayView /&gt;
    /// &lt;/CrestScheduler&gt;
    ...
    /// <code>
    /// &lt;CrestScheduler Data=@appointments TItem="Appointment" 
    ...
    public partial class CrestScheduler<TItem> : CrestComponent, IScheduler
    {
        /// <summary>
        ...
        /// <example>
        /// <code>
        /// &lt;CrestScheduler Data="@data" TItem="DataItem" StartProperty="Start" EndProperty="End" TextProperty="Text"&gt;
        ...
        /// <summary>
        /// Gets or sets the data of CrestScheduler. It will display an appointment for every item of the collection which is within the current view date range.
        /// </summary>
        ...
        [Parameter]
        public string TodayText { get => todayText ?? Localize(nameof(CrestStrings.Scheduler_TodayText)); set => todayText = value; }
        ...
        [Parameter]
        public string NextText { get => nextText ?? Localize(nameof(CrestStrings.Scheduler_NextText)); set => nextText = value; }
        ...
        [Parameter]
        public string PrevText { get => prevText ?? Localize(nameof(CrestStrings.Scheduler_PrevText)); set => prevText = value; }
        ...
        /// <example>
        /// <code>
        /// &lt;CrestScheduler Data=@appointments SlotSelect=@OnSlotSelect&gt;
        /// &lt;/CrestScheduler&gt;
        /// @code {
        ...
        /// <example>
        /// <code>
        /// &lt;CrestScheduler Data=@appointments TodaySelect=@OnTodaySelect&gt;
        /// &lt;/CrestScheduler&gt;
        /// @code {
        ...
        /// <example>
        /// <code>
        /// &lt;CrestScheduler Data=@appointments MonthSelect=@OnMonthSelect&gt;
        /// &lt;/CrestScheduler&gt;
        /// @code {
        ...
        /// <example>
        /// <code>
        /// &lt;CrestScheduler Data=@appointments DaySelect=@OnDaySelect&gt;
        /// &lt;/CrestScheduler&gt;
        /// @code {
        ...
        /// <example>
        /// <code>
        /// &lt;CrestScheduler Data=@appointments AppointmentSelect=@OnAppointmentSelect&gt;
        /// &lt;/CrestScheduler&gt;
        /// @code {
        ...
        /// <example>
        /// <code>
        /// &lt;CrestScheduler Data=@appointments MoreSelect=@OnMoreSelect&gt;
        /// &lt;/CrestScheduler&gt;
        /// @code {
        ...
        /// <example>
        /// <code>
        /// &lt;CrestScheduler Data=@appointments AppointmentRender=@OnAppointmentRendert&gt;
        /// &lt;/CrestScheduler&gt;
        /// @code {
        ...
        /// <example>
        /// <code>
        /// &lt;CrestScheduler Data=@appointments SlotRender=@OnSlotRender&gt;
        /// &lt;/CrestScheduler&gt;
        /// @code {
        ...
        /// <example>
        /// <code>
        /// &lt;CrestScheduler Data=@appointments AppointmentMove=@OnAppointmentMove&gt;
        /// &lt;/CrestScheduler&gt;
        /// @code {
