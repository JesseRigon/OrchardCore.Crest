...
{
    /// <summary>
    /// Interface that has to be implemented by a view in order to by supported by <see cref="CrestScheduler{TItem}" />.
    /// </summary>
    public interface ISchedulerView
    {
        ...
        string Icon { get; }
        /// <summary>
        /// Gets the title of the view. It is displayed in the CrestScheduler title area.
        /// </summary>
        ...
        /// <summary>
        /// Returns a new date when the user clicks the next button of CrestScheduler.
        /// </summary>
        /// <returns>The next date. For example a day view will return the next day, a week view will return the next week.</returns>
        DateTime Next();

        /// <summary>
        /// Returns a new date when the user clicks the previous button of CrestScheduler.
        /// </summary>
