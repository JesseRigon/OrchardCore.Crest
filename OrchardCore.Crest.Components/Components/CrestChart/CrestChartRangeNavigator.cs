...
{
    /// <summary>
    /// Attaches a <see cref="CrestRangeNavigator" /> below a <see cref="CrestChart" />, automatically bound to the chart's view range.
    ...
    /// Declare <see cref="CrestRangeNavigatorLineSeries{TItem}" /> children to display a data preview, or leave empty for a compact navigator.
    /// </summary>
    /// <example>
    /// <code>
    ///   &lt;CrestChart AllowZoom="true" AllowPan="true"&gt;
    ///       &lt;CrestLineSeries Data=@data CategoryProperty="Date" ValueProperty="Value" /&gt;
    ///       &lt;CrestChartRangeNavigator&gt;
    ///           &lt;CrestRangeNavigatorLineSeries Data=@data CategoryProperty="Date" ValueProperty="Value" /&gt;
    ///       &lt;/CrestChartRangeNavigator&gt;
    ///   &lt;/CrestChart&gt;
    /// </code>
    /// </example>
    public partial class CrestChartRangeNavigator : CrestChartComponentBase
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the child content. Used to declare <see cref="CrestRangeNavigatorLineSeries{TItem}" /> preview series.
        /// </summary>
