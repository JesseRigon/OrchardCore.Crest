...
namespace Crest.Components.Primitives.Rendering
{
    ...
    public static class AxisMeasurer
    {
        ...
        public static double YAxis(ScaleBase scale, AxisBase axis, CrestAxisTitle title)
        {
        ...
        /// <param name="title">The title.</param>
        /// <returns>System.Double.</returns>
        public static double XAxis(ScaleBase scale, AxisBase axis, CrestAxisTitle title)
        {
            ArgumentNullException.ThrowIfNull(axis);
            ArgumentNullException.ThrowIfNull(scale);
            ArgumentNullException.ThrowIfNull(title);
