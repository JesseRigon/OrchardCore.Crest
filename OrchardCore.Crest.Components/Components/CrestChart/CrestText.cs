...
namespace Crest.Components.Primitives
{
    ...
    /// CrestText provides consistent text formatting for headings, subtitles, body text, captions, and more with semantic HTML tags.
    ...
    /// Heading text:
    /// <code>
    /// &lt;CrestText TextStyle="TextStyle.H3"&gt;Welcome to Our Application&lt;/CrestText&gt;
    /// </code>
    /// Subtitle with alignment:
    /// <code>
    /// &lt;CrestText TextStyle="TextStyle.Subtitle1" TextAlign="TextAlign.Center"&gt;
    ///     This is a centered subtitle
    /// &lt;/CrestText&gt;
    /// </code>
    /// Body text with custom tag:
    /// <code>
    /// &lt;CrestText TextStyle="TextStyle.Body1" TagName="TagName.Div"&gt;
    ///     This is body text rendered as a div element.
    /// &lt;/CrestText&gt;
    /// </code>
    /// </example>
    public class CrestText : CrestComponent
    {
        class CrestTextAnchor : ComponentBase, IDisposable
        {
            [Inject]
        ...
        {
            get => anchorAriaLabel ?? Localize(nameof(CrestStrings.Text_AnchorAriaLabel));
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            if (Visible)
            {
                ...
                {
                    builder.OpenComponent<CrestTextAnchor>(6);
                    builder.AddAttribute(7, nameof(CrestTextAnchor.Path), Anchor);
                    builder.AddAttribute(8, nameof(CrestTextAnchor.AriaLabel), AnchorAriaLabel);
                    builder.CloseComponent();
                }
