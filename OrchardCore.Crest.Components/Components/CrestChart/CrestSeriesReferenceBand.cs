...
using Path = Crest.Components.Primitives.Rendering.Path;
...
namespace Crest.Components.Primitives
{
    ...
    ///          &lt;CrestSeriesReferenceBand From="240000" To="280000" Title="Acceptable range" /&gt;
    ///       &lt;/CrestLineSeries&gt;
    ///   &lt;/CrestChart&gt;
    ///   @code {
    ///       class DataItem
    ...
    /// </code>
    /// </example>
    public class CrestSeriesReferenceBand : CrestGridLines, IChartSeriesOverlay, IDisposable
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrestSeriesReferenceBand"/> class.
        /// </summary>
        public CrestSeriesReferenceBand()
        {
            Visible = true;
        }
