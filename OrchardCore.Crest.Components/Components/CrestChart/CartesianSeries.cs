...
{
    /// <summary>
    /// Base class of <see cref="CrestChart" /> series.
    /// </summary>
    ...
    public abstract class CartesianSeries<TItem> : CrestChartComponentBase, IChartSeries, IChartValueAxisSeries, IDisposable
    {
        /// <summary>
        ...
        /// <summary>
        /// Returns the parent <see cref="CrestChart"/> instance or throws an <see cref="InvalidOperationException"/> if not present.
        /// </summary>
        /// <returns>The parent <see cref="CrestChart"/>.</returns>
        /// <exception cref="InvalidOperationException">Thrown when the parent chart is not set.</exception>
        protected CrestChart RequireChart()
        {
            return Chart ?? throw new InvalidOperationException($"{GetType().Name} requires a parent CrestChart.");
        }
        ...
        /// <inheritdoc />
        public CrestMarkers Markers { get; set; } = new CrestMarkers();
