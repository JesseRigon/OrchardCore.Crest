...
{
    /// <summary>
    /// Base class of components that are rendered inside a <see cref="CrestChart" />.
    /// </summary>
    public abstract class CrestChartComponentBase : ComponentBase
    {
        private CrestChart? chart;

        /// <summary>
        /// Used to inject the CrestChart instance. Invokes <see cref="Initialize" />.
        /// </summary>
        /// <value>The chart.</value>
        [CascadingParameter]
        public CrestChart? Chart
        {
            get
            {
                return chart;
        ...
        /// <summary>
        /// Determines if CrestChart should render.
        /// </summary>
