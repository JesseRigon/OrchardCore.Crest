...
namespace Crest.Components.Primitives
{
    ...
    /// <see cref="CrestCategoryAxis"/> or <see cref="CrestValueAxis"/> to draw a crosshair line
    /// for that axis while hovering the chart <c>xAxis.crosshair</c> /
    /// <c>yAxis.crosshair</c>. The category axis owns the vertical line; the value axis owns the
    /// horizontal line.
    /// </summary>
    public class CrestAxisCrosshair : CrestChartComponentBase
    {
        /// <summary>
