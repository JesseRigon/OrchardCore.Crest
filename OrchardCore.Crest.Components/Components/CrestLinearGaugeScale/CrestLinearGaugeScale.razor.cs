...
{
    /// <summary>
    /// CrestLinearGaugeScale component.
    /// </summary>
    public partial class CrestLinearGaugeScale : ComponentBase
    {
        /// <summary>
        /// Gets or sets the parent linear gauge.
        /// </summary>
        [CascadingParameter]
        public CrestLinearGauge? Gauge { get; set; }
        ...
        /// </summary>
        [Parameter]
        public global::Crest.Components.Primitives.Orientation Orientation { get; set; } = global::Crest.Components.Primitives.Orientation.Horizontal;
        ...
        /// Automatically propagated from the parent <see cref="CrestLinearGauge"/>.
        /// </summary>
        ...
        private Point NaturalStart
        {
            get
            {
                ...
                if (Orientation == global::Crest.Components.Primitives.Orientation.Vertical)
                {
        ...
        private bool IsEffectivelyReversed => Reversed != (IsRTL && Orientation == global::Crest.Components.Primitives.Orientation.Horizontal);
        ...
        private double ScaleY(CrestLinearGauge gauge)
        {
        ...
        private double ScaleX(CrestLinearGauge gauge)
        {
