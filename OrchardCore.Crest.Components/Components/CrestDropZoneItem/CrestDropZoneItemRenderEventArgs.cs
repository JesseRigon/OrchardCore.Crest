...
/// <summary>
/// Supplies information about CrestDropZoneContainer ItemRender event.
/// </summary>
public class CrestDropZoneItemRenderEventArgs<TItem>
{
    /// <summary>
    /// Gets the drop zone.
    /// </summary>
    public CrestDropZone<TItem>? Zone { get; internal set; }
