...
/// <summary>
/// The configuration used by a <see cref="CrestTreeItem" /> to create child items.
/// </summary>
public class TreeItemSettings
{
    /// <summary>
    /// Gets or sets the data from which child items will be created. The parent node enumerates the data and creates a new CrestTreeItem for every item.
    /// </summary>
    public IEnumerable? Data { get; set; }

    /// <summary>
    /// Gets or sets the function which returns a value for the <see cref="CrestTreeItem.Text" /> of a child item.
    /// </summary>
    public Func<object, string>? Text { get; set; }

    /// <summary>
    /// Gets or sets the function which returns a value for the <see cref="CrestTreeItem.Checkable" /> of a child item.
    /// </summary>
    public Func<object, bool>? Checkable { get; set; }

    /// <summary>
    /// Gets or sets the name of the property which provides the value for the <see cref="CrestTreeItem.Text" /> of a child item.
    /// </summary>
    public string? TextProperty { get; set; }

    /// <summary>
    /// Gets or sets the name of the property which provides the value for the <see cref="CrestTreeItem.Checkable" /> of a child item.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the <see cref="CrestTreeItem.Template" /> of a child item.
    /// </summary>
