...
{
    /// <summary>
    /// A collapsible sidebar component for application navigation, typically used within CrestLayout.
    /// CrestSidebar provides a navigation panel that can be toggled open/closed and responds to screen size changes.
    ...
    /// <code>
    /// &lt;CrestSidebar Position="SidebarPosition.Right" FullHeight="true"&gt;
    ///     Sidebar content...
    /// &lt;/CrestSidebar&gt;
    /// </code>
    /// </example>
    public partial class CrestSidebar : CrestComponentWithChildren
    {
        ...
        /// Responsive mode only works when CrestSidebar is inside <see cref="CrestLayout"/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="CrestSidebar"/> is expanded.
        /// </summary>
