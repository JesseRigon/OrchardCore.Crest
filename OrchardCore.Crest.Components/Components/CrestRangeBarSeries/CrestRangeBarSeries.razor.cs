...
{
    /// <summary>
    /// A chart series that displays data as horizontal range bars in a CrestChart.
    ...
    /// <code>
    /// &lt;CrestChart&gt;
    ///     &lt;CrestRangeBarSeries Data=@data CategoryProperty="Task"
    ///         MinProperty="Start" MaxProperty="End" Title="Timeline" /&gt;
    /// &lt;/CrestChart&gt;
    /// </code>
    /// </example>
    [UnconditionalSuppressMessage(TrimMessages.Trimming, TrimMessages.IL2026, Justification = TrimMessages.DataTypePreserved)]
    public partial class CrestRangeBarSeries<TItem> : CartesianSeries<TItem>, IChartBarSeries
    {
        /// <summary>
