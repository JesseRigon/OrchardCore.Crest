...
/// </summary>
public static class CrestBarcodeEncoder
{
    ...
    public static string ToSvg(CrestBarcodeType type, string value, double barHeight = 50, int quietZoneModules = 10, string foreground = "#000000", string background = "#FFFFFF")
    {
        ArgumentNullException.ThrowIfNull(value);
    ...
    static (IReadOnlyList<BarcodeRect> bars, double vbWidth, double vbHeight) EncodeToBars(CrestBarcodeType type, string value, double barHeight, int quietZoneModules)
    {
        switch (type)
        {
            case CrestBarcodeType.Code128:
            {
