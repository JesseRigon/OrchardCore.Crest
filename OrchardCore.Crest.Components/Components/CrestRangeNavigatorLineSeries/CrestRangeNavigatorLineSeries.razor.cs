...
{
    /// <summary>
    /// Renders a filled area with a line stroke inside a <see cref="CrestRangeNavigator" />.
    /// </summary>
    ...
    public partial class CrestRangeNavigatorLineSeries<TItem> : ComponentBase, IRangeNavigatorSeries, IDisposable
    {
        /// <summary>
        /// Gets or sets the parent navigator.
        /// </summary>
        [CascadingParameter]
        public CrestRangeNavigator? Navigator { get; set; }
