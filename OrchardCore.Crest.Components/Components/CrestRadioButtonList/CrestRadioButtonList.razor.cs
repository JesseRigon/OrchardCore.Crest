...
namespace Crest.Components.Primitives
{
    ...
    /// CrestRadioButtonList displays multiple radio buttons with configurable layout, orientation, and data binding.
    ...
    /// <code>
    /// &lt;CrestRadioButtonList @bind-Value=@selectedOption TValue="string" Orientation="Orientation.Vertical"&gt;
    ///     &lt;Items&gt;
    ///         &lt;CrestRadioButtonListItem Text="Option 1" Value="option1" /&gt;
    ///         &lt;CrestRadioButtonListItem Text="Option 2" Value="option2" /&gt;
    ///         &lt;CrestRadioButtonListItem Text="Option 3" Value="option3" /&gt;
    ///     &lt;/Items&gt;
    /// &lt;/CrestRadioButtonList&gt;
    /// </code>
    /// Data-bound radio list with disabled item:
    /// <code>
    /// &lt;CrestRadioButtonList @bind-Value=@paymentMethod TValue="int" Data=@paymentMethods 
    ...
    public partial class CrestRadioButtonList<TValue> : FormComponent<TValue>, IRadzenRadioButtonList
    {
        ...
        void UpdateAllItems()
        {
            ...
            {
                var item = new CrestRadioButtonListItem<TValue>();
