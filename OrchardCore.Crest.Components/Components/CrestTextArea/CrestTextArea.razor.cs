...
namespace Crest.Components.Primitives
{
    ...
    /// CrestTextArea provides a resizable textarea with data binding, validation, and automatic sizing options.
    ...
    /// Basic textarea:
    /// <code>
    /// &lt;CrestTextArea @bind-Value=@description Rows="5" Placeholder="Enter description..." /&gt;
    /// </code>
    /// Textarea with character limit:
    /// <code>
    /// &lt;CrestTextArea @bind-Value=@comment Rows="4" Cols="50" MaxLength="500" Placeholder="Enter your comment (max 500 characters)" /&gt;
    /// </code>
    /// Read-only textarea for display:
    /// <code>
    /// &lt;CrestTextArea Value=@savedContent Rows="10" ReadOnly="true" /&gt;
    /// </code>
    /// </example>
    public partial class CrestTextArea : FormComponent<string>
    {
        /// <summary>
