...
{
    /// <summary>
    /// Renders 100% stacked column series in <see cref="CrestChart" />.
    /// Values are normalized so that each category totals 100%.
    /// </summary>
    /// <typeparam name="TItem">The type of the series data item.</typeparam>
    public partial class CrestFullStackedColumnSeries<TItem> : CartesianSeries<TItem>, IChartFullStackedColumnSeries
    {
        /// <summary>
