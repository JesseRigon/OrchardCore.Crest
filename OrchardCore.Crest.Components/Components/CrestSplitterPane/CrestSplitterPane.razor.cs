...
{
    /// <summary>
    /// CrestSplitterPane component.
    /// </summary>
    public partial class CrestSplitterPane : CrestComponent
    {
        private CrestSplitter? splitter;
        private string? size;
        ...
        internal CrestSplitterPane? Next()
        {
            if (Splitter == null)
            {
                return null;
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="CrestSplitterPane"/> is collapsible.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="CrestSplitterPane"/> is collapsed.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="CrestSplitterPane"/> is resizable.
        /// </summary>
        ...
        {
            get => resizeAriaLabel ?? string.Format(CultureInfo.CurrentCulture, Localize(nameof(CrestStrings.Splitter_ResizeAriaLabel)), GetId());
        ...
        {
            get => collapseAriaLabel ?? Localize(nameof(CrestStrings.Splitter_CollapseAriaLabel));
        ...
        {
            get => expandAriaLabel ?? Localize(nameof(CrestStrings.Splitter_ExpandAriaLabel));
