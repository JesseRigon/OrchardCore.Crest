...
{
    /// <summary>
    /// Displays the appointments as an agenda <see cref="CrestScheduler{TItem}" />
    /// </summary>
    /// <example>
    /// <code>
    ...
    /// </code>
    /// </example>
    public partial class CrestAgendaView : SchedulerViewBase
    {
        /// <inheritdoc />
        ...
        /// <inheritdoc />
        [Parameter]
        public override string Text { get => text ?? Localize(nameof(CrestStrings.AgendaView_Text)); set => text = value; }
        private string? text;
        ...
        [Parameter]
        public string MultiDayText { get => multiDayText ?? Localize(nameof(CrestStrings.AgendaView_MultiDayText)); set => multiDayText = value; }
