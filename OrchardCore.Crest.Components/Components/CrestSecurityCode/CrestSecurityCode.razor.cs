...
{
    /// <summary>
    /// CrestRating component.
    /// </summary>
    /// <example>
    /// <code>
    /// &lt;CrestRating Stars="10" Change=@(args => Console.WriteLine($"Value: {args}")) /&gt;
    /// </code>
    /// </example>
    public partial class CrestSecurityCode : FormComponent<string>
    {
        /// <inheritdoc />
        ...
        [Parameter]
        public string AriaLabel { get => ariaLabel ?? Localize(nameof(CrestStrings.SecurityCode_AriaLabel)); set => ariaLabel = value; }
        ...
        [Parameter]
        public string InputAriaLabelFormat { get => inputAriaLabelFormat ?? Localize(nameof(CrestStrings.SecurityCode_InputAriaLabelFormat)); set => inputAriaLabelFormat = value; }
        ...
        [JSInvokable("CrestSecurityCode.OnValueChange")]
