...
namespace Crest.Components.Primitives
{
    ...
    /// CrestButton provides a consistent and accessible way to trigger actions in your Blazor application.
    ...
    /// <code>
    /// &lt;CrestButton Click=@(args => Console.WriteLine("Button clicked")) Text="Click Me" /&gt;
    /// </code>
    /// Button with icon and custom style:
    /// <code>
    /// &lt;CrestButton Icon="save" Text="Save" ButtonStyle="ButtonStyle.Success" Variant="Variant.Flat" Size="ButtonSize.Large" /&gt;
    /// </code>
    /// Button with busy state:
    /// <code>
    /// &lt;CrestButton IsBusy=@isSaving BusyText="Saving..." Text="Save" Click=@SaveData /&gt;
    /// </code>
    /// </example>
    public partial class CrestButton : CrestComponent
    {
        /// <summary>
        ...
        [Parameter]
        public string ImageAlternateText { get => imageAlternateText ?? Localize(nameof(CrestStrings.Button_ImageAlternateText)); set => imageAlternateText = value; }
