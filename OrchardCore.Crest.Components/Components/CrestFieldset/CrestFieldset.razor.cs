...
namespace Crest.Components.Primitives
{
    ...
    /// CrestFieldset provides semantic form grouping with visual borders, useful for organizing complex forms into logical sections.
    ...
    /// <code>
    /// &lt;CrestFieldset Text="Personal Information"&gt;
    ///     &lt;CrestStack Gap="1rem"&gt;
    ///         &lt;CrestFormField Text="First Name"&gt;
    ///             &lt;CrestTextBox @bind-Value=@model.FirstName /&gt;
    ///         &lt;/CrestFormField&gt;
    ///         &lt;CrestFormField Text="Last Name"&gt;
    ///             &lt;CrestTextBox @bind-Value=@model.LastName /&gt;
    ///         &lt;/CrestFormField&gt;
    ///     &lt;/CrestStack&gt;
    /// &lt;/CrestFieldset&gt;
    /// </code>
    ...
    /// <code>
    /// &lt;CrestFieldset Text="Advanced Options" Icon="settings" AllowCollapse="true"&gt;
    ///     Advanced configuration fields...
    /// &lt;/CrestFieldset&gt;
    /// </code>
    /// </example>
    public partial class CrestFieldset : CrestComponent
    {
        /// <inheritdoc />
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="CrestFieldset"/> is collapsed.
        /// </summary>
