...
{
    /// <summary>
    /// CrestSankeyDiagram component.
    /// </summary>
    /// <typeparam name="TItem">The type of data item.</typeparam>
    [UnconditionalSuppressMessage(TrimMessages.Trimming, TrimMessages.IL2026, Justification = TrimMessages.DataTypePreserved)]
    public partial class CrestSankeyDiagram<TItem> : CrestComponent
    {
        /// <summary>
        ...
        /// </summary>
        [Parameter]
        public string ValueText { get => valueText ?? Localize(nameof(CrestStrings.SankeyDiagram_ValueText)); set => valueText = value; }
        ...
        /// </summary>
        [Parameter]
        public string IncomingText { get => incomingText ?? Localize(nameof(CrestStrings.SankeyDiagram_IncomingText)); set => incomingText = value; }
        ...
        /// </summary>
        [Parameter]
        public string OutgoingText { get => outgoingText ?? Localize(nameof(CrestStrings.SankeyDiagram_OutgoingText)); set => outgoingText = value; }
        ...
        /// </summary>
        [Parameter]
        public string FlowText { get => flowText ?? Localize(nameof(CrestStrings.SankeyDiagram_FlowText)); set => flowText = value; }
