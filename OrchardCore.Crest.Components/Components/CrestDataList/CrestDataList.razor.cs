...
namespace Crest.Components.Primitives
{
    ...
    /// CrestDataList provides a flexible way to render data in cards, tiles, or custom layouts instead of traditional table rows.
    ...
    /// Use Template to define how each item should be rendered. The template receives the item as @context. Combine with CrestRow/CrestColumn for grid-based layouts or CrestCard for card designs.
    /// </summary>
    ...
    /// <code>
    /// &lt;CrestDataList Data=@products TItem="Product" AllowPaging="true" PageSize="12"&gt;
    ///     &lt;Template Context="product"&gt;
    ///         &lt;CrestCard Style="width: 250px; margin: 1rem;"&gt;
    ///             &lt;CrestImage Path=@product.ImageUrl Style="width: 100%;" /&gt;
    ///             &lt;CrestText TextStyle="TextStyle.H6"&gt;@product.Name&lt;/CrestText&gt;
    ///             &lt;CrestText&gt;@product.Price.ToString("C")&lt;/CrestText&gt;
    ///         &lt;/CrestCard&gt;
    ///     &lt;/Template&gt;
    /// &lt;/CrestDataList&gt;
    /// </code>
    ...
    /// <code>
    /// &lt;CrestDataList Data=@items TItem="Item" WrapItems="true" ShowEmptyMessage="true" EmptyText="No items found"&gt;
    ...
    public partial class CrestDataList<TItem> : PagedDataBoundComponent<TItem>
    {
        /// <inheritdoc />
        ...
        {
            get { return emptyText ?? Localize(nameof(CrestStrings.DataList_EmptyText)); }
            set
            {
                if (value != emptyText)
                {
        ...
        {
            builder.OpenComponent<CrestDataListRow<TItem>>(0);
