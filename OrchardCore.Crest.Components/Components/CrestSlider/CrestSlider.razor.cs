...
namespace Crest.Components.Primitives
{
    ...
    /// CrestSlider supports single value selection or range selection (min/max) with horizontal or vertical orientation.
    ...
    /// Basic slider:
    /// <code>
    /// &lt;CrestSlider @bind-Value=@volume TValue="int" Min="0" Max="100" /&gt;
    /// @code {
    ///     int volume = 50;
    /// }
    /// </code>
    ...
    /// <code>
    /// &lt;CrestSlider @bind-Value=@priceRange TValue="IEnumerable&lt;decimal&gt;" Range="true" 
    ...
    /// <code>
    /// &lt;CrestSlider @bind-Value=@value TValue="double" Min="0" Max="1" Step="0.1" 
    ...
    public partial class CrestSlider<TValue> : FormComponent<TValue>
    {
        ...
        [JSInvokable("CrestSlider.OnValueChange")]
        ...
        /// </summary>
        [Parameter]
        public string HandleLabel { get => handleLabel ?? Localize(nameof(CrestStrings.Slider_HandleLabel)); set => handleLabel = value; }
        ...
        /// </summary>
        [Parameter]
        public string MinHandleLabel { get => minHandleLabel ?? Localize(nameof(CrestStrings.Slider_MinHandleLabel)); set => minHandleLabel = value; }
        ...
        /// </summary>
        [Parameter]
        public string MaxHandleLabel { get => maxHandleLabel ?? Localize(nameof(CrestStrings.Slider_MaxHandleLabel)); set => maxHandleLabel = value; }
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="CrestSlider{TValue}"/> is range.
        /// </summary>
