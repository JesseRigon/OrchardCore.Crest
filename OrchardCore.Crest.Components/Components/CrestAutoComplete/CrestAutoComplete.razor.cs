...
namespace Crest.Components.Primitives
{
    ...
    /// CrestAutoComplete combines a text input with a suggestion dropdown that filters and displays matching items, enabling quick selection without typing complete values.
    ...
    /// Basic autocomplete:
    /// <code>
    /// &lt;CrestAutoComplete @bind-Value=@customerName Data=@customers TextProperty="CompanyName" /&gt;
    /// </code>
    /// Autocomplete with custom filtering and delay:
    /// <code>
    /// &lt;CrestAutoComplete @bind-Value=@search Data=@products TextProperty="ProductName"
    ...
    public partial class CrestAutoComplete : DataBoundFormComponent<string>
    {
        object? selectedItem;
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="CrestAutoComplete"/> is multiline.
        /// </summary>
        ...
        async Task DebounceFilter()
        {
            ...
            else
            {
                ...
                await InvokeAsync(() => { LoadData.InvokeAsync(new Crest.Components.Primitives.LoadDataArgs() { Filter = customSearchText }); });
            }
        }
