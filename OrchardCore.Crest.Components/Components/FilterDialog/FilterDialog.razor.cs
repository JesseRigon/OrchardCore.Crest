...
public partial class FilterDialog : SpreadsheetDialogBase
{
    ...
    private void InitializeFieldName()
    {
        ...
        if (rangeToUse != RangeRef.Invalid)
        {
            ...
            fieldName = string.IsNullOrEmpty(headerText) ? string.Format(System.Globalization.CultureInfo.CurrentCulture, L(nameof(CrestStrings.Spreadsheet_ColumnFormat)), Column + 1) : headerText;
        }
        else
        {
            fieldName = string.Format(System.Globalization.CultureInfo.CurrentCulture, L(nameof(CrestStrings.Spreadsheet_ColumnFormat)), Column + 1);
        }
    }
    ...
    private void InitializeAvailableOperators()
    {
        availableOperators = [
            ...
            new FilterOperatorOption { Text = L(nameof(CrestStrings.Spreadsheet_FilterEquals)), Value = FilterOperator.Equals },
            new FilterOperatorOption { Text = L(nameof(CrestStrings.Spreadsheet_FilterDoesNotEqual)), Value = FilterOperator.NotEquals },
            new FilterOperatorOption { Text = L(nameof(CrestStrings.Spreadsheet_FilterGreaterThan)), Value = FilterOperator.GreaterThan },
            new FilterOperatorOption { Text = L(nameof(CrestStrings.Spreadsheet_FilterGreaterThanOrEqual)), Value = FilterOperator.GreaterThanOrEqual },
            new FilterOperatorOption { Text = L(nameof(CrestStrings.Spreadsheet_FilterLessThan)), Value = FilterOperator.LessThan },
            new FilterOperatorOption { Text = L(nameof(CrestStrings.Spreadsheet_FilterLessThanOrEqual)), Value = FilterOperator.LessThanOrEqual },
            new FilterOperatorOption { Text = L(nameof(CrestStrings.Spreadsheet_FilterBeginsWith)), Value = FilterOperator.BeginsWith },
            new FilterOperatorOption { Text = L(nameof(CrestStrings.Spreadsheet_FilterDoesNotBeginWith)), Value = FilterOperator.DoesNotBeginWith },
            new FilterOperatorOption { Text = L(nameof(CrestStrings.Spreadsheet_FilterEndsWith)), Value = FilterOperator.EndsWith },
            new FilterOperatorOption { Text = L(nameof(CrestStrings.Spreadsheet_FilterDoesNotEndWith)), Value = FilterOperator.DoesNotEndWith },
            new FilterOperatorOption { Text = L(nameof(CrestStrings.Spreadsheet_FilterContains)), Value = FilterOperator.Contains },
            new FilterOperatorOption { Text = L(nameof(CrestStrings.Spreadsheet_FilterDoesNotContain)), Value = FilterOperator.DoesNotContain },
            new FilterOperatorOption { Text = L(nameof(CrestStrings.Spreadsheet_FilterIsEmpty)), Value = FilterOperator.IsEmpty },
            new FilterOperatorOption { Text = L(nameof(CrestStrings.Spreadsheet_FilterIsNotEmpty)), Value = FilterOperator.IsNotEmpty }
        ];
    }
    ...
    {
        logicalOperators = [
            new LogicalOperatorOption { Text = L(nameof(CrestStrings.Spreadsheet_FilterAnd)), Value = LogicalFilterOperator.And },
            new LogicalOperatorOption { Text = L(nameof(CrestStrings.Spreadsheet_FilterOr)), Value = LogicalFilterOperator.Or }
        ];
    }
