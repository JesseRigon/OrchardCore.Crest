...
{
    /// <summary>
    /// A chart series that displays data as a horizontal waterfall chart in a CrestChart.
    ...
    /// <code>
    /// &lt;CrestChart&gt;
    ///     &lt;CrestHorizontalWaterfallSeries Data=@data CategoryProperty="Label" ValueProperty="Amount"
    ///         SummaryProperty="IsTotal" Title="Cash Flow" /&gt;
    /// &lt;/CrestChart&gt;
    /// </code>
    /// </example>
    [UnconditionalSuppressMessage(TrimMessages.Trimming, TrimMessages.IL2026, Justification = TrimMessages.DataTypePreserved)]
    public partial class CrestHorizontalWaterfallSeries<TItem> : CartesianSeries<TItem>, IChartBarSeries
    {
        /// <summary>
