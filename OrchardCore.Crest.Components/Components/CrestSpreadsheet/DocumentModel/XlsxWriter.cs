...
class XlsxWriter(Workbook sourceWorkbook)
{
    ...
    private static void SaveTheme(ZipArchive archive)
    {
        ...
        using var resource = assembly.GetManifestResourceStream("Crest.Components.Primitives.Documents.Spreadsheet.theme1.xml")
    ...
    private void SaveDocPropsApp(ZipArchive archive)
    {
        ...
        var doc = new XDocument(
            ...
            new XElement(ep + "Properties",
                ...
                new XElement(ep + "Application", "Crest.Components.Primitives"),
                headingPairs,
                titlesOfParts));
