...
public class ChartOverlay : DrawingOverlayBase<SheetChart>
{
    ...
    protected override void OnDrawingContextMenu(MouseEventArgs e, SheetChart drawing)
    {
        ...
        {
            new() { Text = L(nameof(CrestStrings.Spreadsheet_EditChart)), Value = "edit-chart", Icon = "edit" },
            new() { Text = L(nameof(CrestStrings.Spreadsheet_DeleteChart)), Value = "delete-chart", Icon = "delete" },
    ...
    {
        if (Spreadsheet is not CrestSpreadsheet spreadsheet)
        {
            return;
        }
        ...
        var title = L(nameof(CrestStrings.Spreadsheet_EditChartTitle));
        object? result;
    ...
    private RenderFragment RenderChart(SheetChart chart, RangeRef chartRange) => builder =>
    {
        ...
        builder.OpenComponent<CrestChart>(0);
        ...
        builder.AddAttribute(2, "ChildContent", (RenderFragment)(chartBuilder =>
        {
            ...
            {
                chartBuilder.OpenComponent<CrestCategoryAxis>(10000);
                chartBuilder.CloseComponent();

                chartBuilder.OpenComponent<CrestValueAxis>(10001);
                chartBuilder.CloseComponent();
            }

            if (chart.ShowLegend)
            {
                chartBuilder.OpenComponent<CrestLegend>(10002);
    ...
    private static Type? GetSeriesComponentType(SpreadsheetChartType chartType)
    {
        ...
        {
            SpreadsheetChartType.Column => typeof(CrestColumnSeries<ChartDataPoint>),
            SpreadsheetChartType.Bar => typeof(CrestBarSeries<ChartDataPoint>),
            SpreadsheetChartType.StackedColumn => typeof(CrestStackedColumnSeries<ChartDataPoint>),
            SpreadsheetChartType.StackedBar => typeof(CrestStackedBarSeries<ChartDataPoint>),
            SpreadsheetChartType.FullStackedColumn => typeof(CrestFullStackedColumnSeries<ChartDataPoint>),
            SpreadsheetChartType.FullStackedBar => typeof(CrestFullStackedBarSeries<ChartDataPoint>),
            SpreadsheetChartType.Line => typeof(CrestLineSeries<ChartDataPoint>),
            SpreadsheetChartType.Area => typeof(CrestAreaSeries<ChartDataPoint>),
            SpreadsheetChartType.StackedArea => typeof(CrestStackedAreaSeries<ChartDataPoint>),
            SpreadsheetChartType.FullStackedArea => typeof(CrestFullStackedAreaSeries<ChartDataPoint>),
            SpreadsheetChartType.Pie => typeof(CrestPieSeries<ChartDataPoint>),
            SpreadsheetChartType.Donut => typeof(CrestDonutSeries<ChartDataPoint>),
            SpreadsheetChartType.Scatter => typeof(CrestScatterSeries<ChartDataPoint>),
            _ => null
        };
    }
