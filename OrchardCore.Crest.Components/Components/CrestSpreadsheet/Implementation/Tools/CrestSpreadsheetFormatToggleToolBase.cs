...
/// </summary>
public abstract class CrestSpreadsheetFormatToggleToolBase : ComponentBase, IDisposable
{
    /// <summary>
    /// The active worksheet, cascaded from the host <see cref="Crest.Components.Primitives.CrestSpreadsheet"/>.
    /// </summary>
    [CascadingParameter]
    public Worksheet? Worksheet { get; set; }

    /// <summary>
    /// The host spreadsheet, cascaded from <see cref="Crest.Components.Primitives.CrestSpreadsheet"/>.
    /// </summary>
    [CascadingParameter]
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="CrestSpreadsheetFormatToggleToolBase"/> class.
    /// </summary>
    protected CrestSpreadsheetFormatToggleToolBase()
    {
