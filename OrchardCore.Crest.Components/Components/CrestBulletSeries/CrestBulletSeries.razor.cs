...
namespace Crest.Components.Primitives
{
    ...
    public partial class CrestBulletSeries<TItem> : CartesianSeries<TItem>
    {
        ...
        /// <summary>
        /// Specifies how the measure bar is filled. Set to <see cref="FillMode.Solid"/> by default.
        ...
        // Swap category and value scales (like CrestBarSeries) for horizontal rendering
        /// <inheritdoc />
