...
namespace Crest.Components.Primitives
{
    ...
    /// CrestStack provides a simpler alternative to CrestRow/CrestColumn for linear layouts without the 12-column grid constraint.
    /// Ideal for creating simple vertical or horizontal layouts without needing a grid system. Unlike CrestRow/CrestColumn which uses a 12-column grid, Stack arranges children linearly with equal spacing.
    ...
    /// <code>
    /// &lt;CrestStack Gap="1rem"&gt;
    ///     &lt;CrestText&gt;First item&lt;/CrestText&gt;
    ///     &lt;CrestText&gt;Second item&lt;/CrestText&gt;
    ///     &lt;CrestText&gt;Third item&lt;/CrestText&gt;
    /// &lt;/CrestStack&gt;
    /// </code>
    /// Horizontal button group:
    /// <code>
    /// &lt;CrestStack Orientation="Orientation.Horizontal" Gap="0.5rem" JustifyContent="JustifyContent.End"&gt;
    ///     &lt;CrestButton Text="Cancel" /&gt;
    ///     &lt;CrestButton Text="Save" ButtonStyle="ButtonStyle.Primary" /&gt;
    /// &lt;/CrestStack&gt;
    /// </code>
    /// Centered content with wrapping:
    /// <code>
    /// &lt;CrestStack Orientation="Orientation.Horizontal" Wrap="FlexWrap.Wrap" AlignItems="AlignItems.Center" Gap="2rem"&gt;
    ///     @* Child elements *@
    /// &lt;/CrestStack&gt;
    /// </code>
    /// </example>
    public partial class CrestStack : CrestFlexComponent
    {
        /// <summary>
