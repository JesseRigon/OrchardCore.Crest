...
namespace Crest.Components.Primitives
{
    ...
    /// </code>
    /// </example>
    public partial class CrestHtmlEditorFormatBlock : ComponentBase, IDisposable
    {
        /// <summary>
        ...
        /// </summary>
        [Parameter]
        public string? Placeholder { get => placeholder ?? Localize(nameof(CrestStrings.HtmlEditorFormatBlock_Placeholder)); set => placeholder = value; }
        ...
        /// </summary>
        [Parameter]
        public string? Title { get => title ?? Localize(nameof(CrestStrings.HtmlEditorFormatBlock_Title)); set => title = value; }
        ...
        /// </summary>
        [Parameter]
        public string? NormalText { get => normalText ?? Localize(nameof(CrestStrings.HtmlEditorFormatBlock_NormalText)); set => normalText = value; }
        ...
        /// </summary>
        [Parameter]
        public string? Heading1Text { get => heading1Text ?? Localize(nameof(CrestStrings.HtmlEditorFormatBlock_Heading1Text)); set => heading1Text = value; }
        ...
        /// </summary>
        [Parameter]
        public string? Heading2Text { get => heading2Text ?? Localize(nameof(CrestStrings.HtmlEditorFormatBlock_Heading2Text)); set => heading2Text = value; }
        ...
        /// </summary>
        [Parameter]
        public string? Heading3Text { get => heading3Text ?? Localize(nameof(CrestStrings.HtmlEditorFormatBlock_Heading3Text)); set => heading3Text = value; }
        ...
        /// </summary>
        [Parameter]
        public string? Heading4Text { get => heading4Text ?? Localize(nameof(CrestStrings.HtmlEditorFormatBlock_Heading4Text)); set => heading4Text = value; }
        ...
        /// </summary>
        [Parameter]
        public string? Heading5Text { get => heading5Text ?? Localize(nameof(CrestStrings.HtmlEditorFormatBlock_Heading5Text)); set => heading5Text = value; }
        ...
        /// </summary>
        [Parameter]
        public string? Heading6Text { get => heading6Text ?? Localize(nameof(CrestStrings.HtmlEditorFormatBlock_Heading6Text)); set => heading6Text = value; }
