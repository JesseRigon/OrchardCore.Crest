...
namespace Crest.Components.Primitives
{
    ...
    public class CrestTemplateForm<TItem> : CrestComponent, IRadzenForm
    {
        ...
        /// <example>
        /// <code>
        /// &lt;CrestTemplateForm TItem="Model" Submit=@OnSubmit Data=@model&gt;
        ///   &lt;CrestTextBox style="display: block" Name="Email" @bind-Value=@model.Email /&gt;
        ///   &lt;CrestRequiredValidator Component="Email" Text="Email is required" Style="position: absolute" /&gt;
        /// &lt;/CrestTemplateForm&gt;
        /// @code {
        ...
        /// <example>
        /// <code>
        /// &lt;CrestTemplateForm TItem="Model" InvalidSubmit=@OnInvalidSubmit Data=@model&gt;
        ///   &lt;CrestTextBox style="display: block" Name="Email" @bind-Value=@model.Email /&gt;
        ///   &lt;CrestRequiredValidator Component="Email" Text="Email is required" Style="position: absolute" /&gt;
        /// &lt;/CrestTemplateForm&gt;
        /// @code {
        ...
        /// <example>
        /// <code>
        /// &lt;CrestTemplateForm TItem="Model" Method="post" Action="/register" Data=@model&gt;
        ///   &lt;CrestTextBox style="display: block" Name="Email" @bind-Value=@model.Email /&gt;
        ///   &lt;CrestRequiredValidator Component="Email" Text="Email is required" Style="position: absolute" /&gt;
        /// &lt;/CrestTemplateForm&gt;
        /// </code>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CrestTemplateForm{TItem}"/> class.
        /// </summary>
        public CrestTemplateForm()
        {
