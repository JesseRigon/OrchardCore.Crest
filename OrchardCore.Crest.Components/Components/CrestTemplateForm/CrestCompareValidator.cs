...
namespace Crest.Components.Primitives
{
    ...
    /// Used by <see cref="CrestCompareValidator"/> to determine how to compare the component value against the target value.
    /// </summary>
    ...
    /// CrestCompareValidator is commonly used for password confirmation, numeric range validation, or ensuring field values match expected criteria.
    ...
    ///    &lt;CrestPassword style="display: block" Name="Password" @bind-Value=@model.Password /&gt;
    ///    &lt;CrestPassword style="display: block" Name="RepeatPassword" @bind-Value=@model.RepeatPassword /&gt;
    ///    &lt;CrestCompareValidator Value=@model.Password Component="RepeatPassword" Text="Passwords should be the same"  Style="position: absolute" /&gt;
    /// &lt;/CrestTemplateForm&gt;
    /// @code {
    ///    class Model
    ///    {
    ...
    /// </code>
    /// </example>
    public class CrestCompareValidator : ValidatorBase
    {
        /// <summary>
        /// Gets or sets the message displayed when the component is invalid. Set to <c>"Value should match"</c> by default.
        /// </summary>
        [Parameter]
        public override string Text { get => text ?? Localize(nameof(CrestStrings.CompareValidator_Text)); set => text = value; }
        private string? text;
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="CrestCompareValidator"/> should be validated on value change of the specified Component.
        /// </summary>
