...
namespace Crest.Components.Primitives
{
    ...
    /// CrestCustomValidator enables complex validation rules that cannot be achieved with built-in validators, such as database checks, cross-field validation, or business rule enforcement.
    ...
    ///     &lt;CrestCustomValidator Component="Email" Text="Email already exists" 
    ...
    /// <code>
    /// &lt;CrestDatePicker Name="StartDate" @bind-Value=@model.StartDate /&gt;
    /// &lt;CrestDatePicker Name="EndDate" @bind-Value=@model.EndDate /&gt;
    /// &lt;CrestCustomValidator Component="EndDate" Validator=@(() => model.EndDate > model.StartDate) 
    ///                        Text="End date must be after start date" /&gt;
    /// </code>
    /// </example>
    public class CrestCustomValidator : ValidatorBase
    {
        /// <summary>
        ...
        [Parameter]
        public override string Text { get => text ?? Localize(nameof(CrestStrings.CustomValidator_Text)); set => text = value; }
        private string? text;
