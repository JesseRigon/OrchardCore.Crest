...
namespace Crest.Components.Primitives
{
    ...
    /// CrestRequiredValidator verifies that required fields are filled before form submission.
    ...
    ///   &lt;CrestRequiredValidator Component="Email" Text="Email is required" Style="position: absolute" /&gt;
    /// &lt;/CrestTemplateForm&gt;
    /// @code {
    ///  class Model
    ///  {
    ...
    /// <code>
    /// &lt;CrestDropDown Name="Country" @bind-Value=@model.CountryId Data=@countries /&gt;
    /// &lt;CrestRequiredValidator Component="Country" DefaultValue="0" Text="Please select a country" /&gt;
    /// </code>
    /// </example>
    public class CrestRequiredValidator : ValidatorBase
    {
        /// <summary>
        ...
        [Parameter]
        public override string Text { get => text ?? Localize(nameof(CrestStrings.RequiredValidator_Text)); set => text = value; }
        private string? text;
