...
namespace Crest.Components.Primitives
{
    ...
    public class DropDownBase<T> : DataBoundFormComponent<T>
    {
        ...
        private async ValueTask<Microsoft.AspNetCore.Components.Web.Virtualization.ItemsProviderResult<object>> LoadItems(Microsoft.AspNetCore.Components.Web.Virtualization.ItemsProviderRequest request)
        {
            ...
            {
                await LoadData.InvokeAsync(new Crest.Components.Primitives.LoadDataArgs() { Skip = request.StartIndex, Top = top, Filter = searchText });
            }
        ...
        [Parameter]
        public string RemoveChipTitle { get => removeChipTitle ?? Localize(nameof(CrestStrings.DropDown_RemoveChipTitle)); set => removeChipTitle = value; }
        ...
        [Parameter]
        public string ClearAriaLabel { get => clearAriaLabel ?? Localize(nameof(CrestStrings.DropDown_ClearAriaLabel)); set => clearAriaLabel = value; }
        ...
        [Parameter]
        public string SearchAriaLabel { get => searchAriaLabel ?? Localize(nameof(CrestStrings.DropDown_SearchAriaLabel)); set => searchAriaLabel = value; }
        ...
        [Parameter]
        public string EmptyAriaLabel { get => emptyAriaLabel ?? Localize(nameof(CrestStrings.DropDown_EmptyAriaLabel)); set => emptyAriaLabel = value; }
        ...
        public virtual object? GetItemOrValueFromProperty(object? item, string property)
        {
            if (item != null)
            {
                ...
                if (enumValue != null)
                {
                    return Crest.Components.Primitives.EnumExtensions.GetDisplayDescription(enumValue);
                }
        ...
        internal virtual async System.Threading.Tasks.Task<LoadDataArgs> GetLoadDataArgs()
        {
            if (AllowVirtualization)
            {
                return await Task.FromResult(new Crest.Components.Primitives.LoadDataArgs() { Skip = 0, Top = PageSize, Filter = searchText });
            }
            else
            {
                return await Task.FromResult(new Crest.Components.Primitives.LoadDataArgs() { Filter = searchText });
            }
        }
