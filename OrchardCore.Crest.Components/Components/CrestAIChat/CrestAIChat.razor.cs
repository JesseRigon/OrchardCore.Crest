...
{
    /// <summary>
    /// CrestAIChat component that provides a modern chat interface with AI integration and conversation memory.
    /// </summary>
    /// <example>
    /// <code>
    /// &lt;CrestAIChat Title="AI Assistant" Placeholder="Type your message..." @bind-Messages="@chatMessages" SessionId="@sessionId" /&gt;
    /// </code>
    /// </example>
    public partial class CrestAIChat : CrestComponent
    {
        ...
        /// </summary>
        [Parameter]
        public string Placeholder { get => placeholder ?? Localize(nameof(CrestStrings.AIChat_Placeholder)); set => placeholder = value; }
        ...
        /// </summary>
        [Parameter]
        public string EmptyMessage { get => emptyMessage ?? Localize(nameof(CrestStrings.AIChat_EmptyMessage)); set => emptyMessage = value; }
        ...
        /// </summary>
        [Parameter]
        public string UserAvatarText { get => userAvatarText ?? Localize(nameof(CrestStrings.AIChat_UserAvatarText)); set => userAvatarText = value; }
        ...
        /// </summary>
        [Parameter]
        public string AssistantAvatarText { get => assistantAvatarText ?? Localize(nameof(CrestStrings.AIChat_AssistantAvatarText)); set => assistantAvatarText = value; }
