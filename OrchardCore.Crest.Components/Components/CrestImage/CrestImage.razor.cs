...
namespace Crest.Components.Primitives
{
    ...
    /// CrestImage provides a simple wrapper for HTML img elements with click event support and alternate text for accessibility.
    ...
    /// <code>
    /// &lt;CrestImage Path="images/logo.png" AlternateText="Company Logo" Style="width: 200px;" /&gt;
    /// </code>
    /// Image with click handler:
    /// <code>
    /// &lt;CrestImage Path=@product.ImageUrl AlternateText=@product.Name Click=@(args => ShowImageGallery(product)) Style="cursor: pointer;" /&gt;
    /// </code>
    /// Image from base64 data:
    /// <code>
    /// &lt;CrestImage Path=@($"data:image/jpeg;base64,{base64String}") AlternateText="Uploaded Photo" /&gt;
    /// </code>
    /// </example>
    public partial class CrestImage : CrestComponentWithChildren
    {
        /// <summary>
        ...
        [Parameter]
        public string AlternateText { get => alternateText ?? Localize(nameof(CrestStrings.Image_AlternateText)); set => alternateText = value; }
