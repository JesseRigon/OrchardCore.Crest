...
{
    /// <summary>
    /// A chart series that extends <see cref="CrestScatterSeries{TItem}"/> to add a third data dimension
    ...
    /// <code>
    /// &lt;CrestChart&gt;
    ///     &lt;CrestBubbleSeries Data=@data CategoryProperty="GDP" ValueProperty="LifeExpectancy"
    ///         SizeProperty="Population" Title="Countries" /&gt;
    /// &lt;/CrestChart&gt;
    /// </code>
    /// </example>
    [UnconditionalSuppressMessage(TrimMessages.Trimming, TrimMessages.IL2026, Justification = TrimMessages.DataTypePreserved)]
    public partial class CrestBubbleSeries<TItem> : CrestScatterSeries<TItem>
    {
        /// <summary>
