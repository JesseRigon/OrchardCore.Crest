...
{
    /// <summary>
    /// A chart series that displays data as a continuous line connecting data points in a CrestChart.
    /// CrestLineSeries is ideal for showing trends over time, continuous data, or comparing multiple data series.
    ...
    /// <code>
    /// &lt;CrestChart&gt;
    ///     &lt;CrestLineSeries Data=@temperatures CategoryProperty="Date" ValueProperty="Temperature" Title="Temperature" /&gt;
    /// &lt;/CrestChart&gt;
    /// </code>
    /// Smooth line with markers:
    /// <code>
    /// &lt;CrestChart&gt;
    ///     &lt;CrestLineSeries Data=@data CategoryProperty="X" ValueProperty="Y" Smooth="true" Stroke="#FF6384" StrokeWidth="3"&gt;
    ///         &lt;CrestMarkers MarkerType="MarkerType.Circle" /&gt;
    ///         &lt;CrestSeriesDataLabels Visible="true" /&gt;
    ///     &lt;/CrestLineSeries&gt;
    /// &lt;/CrestChart&gt;
    /// </code>
    /// </example>
    public partial class CrestLineSeries<TItem> : CartesianSeries<TItem>
    {
        /// <inheritdoc />
