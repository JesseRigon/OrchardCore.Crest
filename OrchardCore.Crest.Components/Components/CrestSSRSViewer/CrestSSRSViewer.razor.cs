...
{
    /// <summary>
    /// CrestSSRSViewer component.
    /// </summary>
    public partial class CrestSSRSViewer : CrestComponent
    {
        /// <summary>
        ...
        List<CrestSSRSViewerParameter> parameters = new List<CrestSSRSViewerParameter>();

        /// <summary>
        /// Adds the parameter.
        /// </summary>
        /// <param name="parameter">The parameter.</param>
        public void AddParameter(CrestSSRSViewerParameter parameter)
        {
