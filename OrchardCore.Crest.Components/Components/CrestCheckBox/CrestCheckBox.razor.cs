...
namespace Crest.Components.Primitives
{
    ...
    /// CrestCheckBox provides data binding, validation, and keyboard accessibility for boolean or nullable boolean values.
    ...
    /// <code>
    /// &lt;CrestCheckBox @bind-Value=@isChecked TValue="bool" /&gt;
    /// </code>
    /// Tri-state checkbox with change handler:
    /// <code>
    /// &lt;CrestCheckBox @bind-Value=@nullableBool TValue="bool?" TriState="true" Change=@(args => Console.WriteLine($"Value: {args}")) /&gt;
    /// </code>
    /// Read-only checkbox for display purposes:
    /// <code>
    /// &lt;CrestCheckBox Value=@isEnabled TValue="bool" ReadOnly="true" /&gt;
    /// </code>
    /// </example>
    public partial class CrestCheckBox<TValue> : FormComponent<TValue>
    {
        /// <summary>
