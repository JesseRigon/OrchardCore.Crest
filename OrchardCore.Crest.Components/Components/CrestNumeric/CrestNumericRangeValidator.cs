...
namespace Crest.Components.Primitives
{
    ...
    /// CrestNumericRangeValidator is ideal for quantity limits, age restrictions, price ranges, or any bounded numeric input.
    ...
    ///     &lt;CrestNumeric Name="Age" @bind-Value=@model.Age /&gt;
    ///     &lt;CrestNumericRangeValidator Component="Age" Min="18" Text="Must be 18 or older" Style="position: absolute" /&gt;
    /// &lt;/CrestTemplateForm&gt;
    /// </code>
    /// Quantity range validation:
    /// <code>
    /// &lt;CrestTemplateForm TItem="Model" Data=@model&gt;
    ///     &lt;CrestNumeric Name="Quantity" @bind-Value=@model.Quantity /&gt;
    ///     &lt;CrestNumericRangeValidator Component="Quantity" Min="1" Max="100" 
    ///                                   Text="Quantity must be between 1 and 100" Style="position: absolute" /&gt;
    /// &lt;/CrestTemplateForm&gt;
    /// </code>
    /// </example>
    public class CrestNumericRangeValidator : ValidatorBase
    {
        /// <summary>
        ...
        [Parameter]
        public override string Text { get => text ?? Localize(nameof(CrestStrings.NumericRangeValidator_Text)); set => text = value; }
        private string? text;
