...
namespace Crest.Components.Primitives
{
    ...
    /// CrestNumeric supports various numeric types, formatting, min/max validation, step increments, and culture-specific number display.
    ...
    /// <code>
    /// &lt;CrestNumeric @bind-Value=@quantity TValue="int" Min="1" Max="100" Step="1" /&gt;
    /// </code>
    /// Decimal input with custom formatting:
    /// <code>
    /// &lt;CrestNumeric @bind-Value=@price TValue="decimal" Min="0" Format="c" Placeholder="Enter price" /&gt;
    /// </code>
    /// Nullable numeric without increment buttons:
    /// <code>
    /// &lt;CrestNumeric @bind-Value=@optionalValue TValue="int?" ShowUpDown="false" Placeholder="Optional" /&gt;
    /// </code>
    ...
    /// <code>
    /// &lt;CrestNumeric @bind-Value=@value TValue="int" KeyDown=@OnKeyDown /&gt;
    /// @code {
    ///     int value;
    ...
    public partial class CrestNumeric<TValue> : FormComponentWithAutoComplete<TValue>
    {
        /// <summary>
        ...
        /// supplied an <c>aria-label</c> or <c>aria-labelledby</c> attribute via <see cref="CrestComponent.Attributes" /> or
        ...
        /// </summary>
        [Parameter]
        public string UpAriaLabel { get => upAriaLabel ?? Localize(nameof(CrestStrings.Numeric_UpAriaLabel)); set => upAriaLabel = value; }
        ...
        /// </summary>
        [Parameter]
        public string DownAriaLabel { get => downAriaLabel ?? Localize(nameof(CrestStrings.Numeric_DownAriaLabel)); set => downAriaLabel = value; }
