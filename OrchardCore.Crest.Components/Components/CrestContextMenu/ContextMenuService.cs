...
namespace Crest.Components.Primitives
{
    ...
    /// Should be added as scoped service in the application services and CrestContextMenu should be added in application main layout.
    ...
    /// &lt;CrestButton Text="Show context menu" ContextMenu=@(args => ShowContextMenuWithContent(args)) /&gt;
    /// @code {
    ///     void ShowContextMenuWithContent(MouseEventArgs args) =&gt; ContextMenuService.Open(args, ds =&gt;
    ///       @&lt;CrestMenu Click="OnMenuItemClick"&gt;
    ///         &lt;CrestMenuItem Text="Item1" Value="1"&gt;&lt;/CrestMenuItem&gt;
    ///         &lt;CrestMenuItem Text="Item2" Value="2"&gt;&lt;/CrestMenuItem&gt;
    ///         &lt;CrestMenuItem Text="More items" Value="3"&gt;
    ///             &lt;CrestMenuItem Text="More sub items" Value="4"&gt;
    ///                 &lt;CrestMenuItem Text="Item1" Value="5"&gt;&lt;/CrestMenuItem&gt;
    ///                 &lt;CrestMenuItem Text="Item2" Value="6"&gt;&lt;/CrestMenuItem&gt;
    ///             &lt;/CrestMenuItem&gt;
    ///         &lt;/CrestMenuItem&gt;
    ///       &lt;/CrestMenu&gt;);
    /// 
