...
{
    /// <summary>
    /// CrestContextMenu component.
    /// </summary>
    /// <example>
    /// <code>
    /// @inject ContextMenuService ContextMenuService
    /// 
    /// &lt;CrestButton Text="Show context menu" ContextMenu=@(args => ShowContextMenuWithItems(args)) /&gt;
    /// 
    /// @code {
    ...
    /// </code>
    /// </example>
    public partial class CrestContextMenu : IAsyncDisposable
    {
        /// <summary>
        ...
        protected override async Task OnAfterRenderAsync(bool firstRender)
        {
            ...
            if (menu != null && menu.MouseEventArgs != null)
            {
                await JSRuntime.InvokeVoidAsync("Crest.openContextMenu",
                    ...
                    UniqueID,
                    Reference,
                    "CrestContextMenu.CloseMenu");
            }
        }

        private DotNetObjectReference<CrestContextMenu>? reference;

        /// <summary>
        /// Gets the reference for the current component.
        /// </summary>
        /// <value>The reference.</value>
        protected DotNetObjectReference<CrestContextMenu> Reference
        {
            get
            {
                if (reference == null)
        ...
        /// Closes this instance.
        /// </summary>
        [JSInvokable("CrestContextMenu.CloseMenu")]
