...
namespace Crest.Components.Primitives
{
    ...
    /// CrestSwitch provides an alternative to checkboxes with a more modern toggle UI pattern, ideal for settings and preferences.
    ...
    /// Basic switch:
    /// <code>
    /// &lt;CrestSwitch @bind-Value=@isEnabled /&gt;
    /// </code>
    /// Switch with label and change event:
    /// <code>
    /// &lt;CrestStack Orientation="Orientation.Horizontal" Gap="0.5rem" AlignItems="AlignItems.Center"&gt;
    ///     &lt;CrestSwitch @bind-Value=@notifications Change=@(enabled => Console.WriteLine($"Notifications: {enabled}")) /&gt;
    ///     &lt;CrestLabel Text="Enable notifications" /&gt;
    /// &lt;/CrestStack&gt;
    /// </code>
    /// Read-only switch for display:
    /// <code>
    /// &lt;CrestSwitch Value=@feature.IsEnabled ReadOnly="true" /&gt;
    /// </code>
    /// </example>
    public partial class CrestSwitch : FormComponent<bool>
    {
        /// <summary>
