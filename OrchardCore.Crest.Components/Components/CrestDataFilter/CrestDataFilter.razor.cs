...
namespace Crest.Components.Primitives
{
    ...
    public partial class CrestDataFilter<TItem> : CrestComponent
    {
        /// <inheritdoc />
        ...
        [Parameter]
        public string FilterText { get => filterText ?? Localize(nameof(CrestStrings.DataFilter_FilterText)); set => filterText = value; }
        ...
        [Parameter]
        public string EnumFilterSelectText { get => enumFilterSelectText ?? Localize(nameof(CrestStrings.DataFilter_EnumFilterSelectText)); set => enumFilterSelectText = value; }
        ...
        [Parameter]
        public string AndOperatorText { get => andOperatorText ?? Localize(nameof(CrestStrings.DataFilter_AndOperatorText)); set => andOperatorText = value; }
        ...
        [Parameter]
        public string OrOperatorText { get => orOperatorText ?? Localize(nameof(CrestStrings.DataFilter_OrOperatorText)); set => orOperatorText = value; }
        ...
        [Parameter]
        public string ApplyFilterText { get => applyFilterText ?? Localize(nameof(CrestStrings.DataFilter_ApplyFilterText)); set => applyFilterText = value; }
        ...
        [Parameter]
        public string ClearFilterText { get => clearFilterText ?? Localize(nameof(CrestStrings.DataFilter_ClearFilterText)); set => clearFilterText = value; }
        ...
        [Parameter]
        public string AddFilterText { get => addFilterText ?? Localize(nameof(CrestStrings.DataFilter_AddFilterText)); set => addFilterText = value; }
        ...
        [Parameter]
        public string RemoveFilterText { get => removeFilterText ?? Localize(nameof(CrestStrings.DataFilter_RemoveFilterText)); set => removeFilterText = value; }
        ...
        [Parameter]
        public string AddFilterGroupText { get => addFilterGroupText ?? Localize(nameof(CrestStrings.DataFilter_AddFilterGroupText)); set => addFilterGroupText = value; }
        ...
        [Parameter]
        public string EqualsText { get => equalsText ?? Localize(nameof(CrestStrings.DataFilter_EqualsText)); set => equalsText = value; }
        ...
        [Parameter]
        public string NotEqualsText { get => notEqualsText ?? Localize(nameof(CrestStrings.DataFilter_NotEqualsText)); set => notEqualsText = value; }
        ...
        [Parameter]
        public string LessThanText { get => lessThanText ?? Localize(nameof(CrestStrings.DataFilter_LessThanText)); set => lessThanText = value; }
        ...
        [Parameter]
        public string LessThanOrEqualsText { get => lessThanOrEqualsText ?? Localize(nameof(CrestStrings.DataFilter_LessThanOrEqualsText)); set => lessThanOrEqualsText = value; }
        ...
        [Parameter]
        public string GreaterThanText { get => greaterThanText ?? Localize(nameof(CrestStrings.DataFilter_GreaterThanText)); set => greaterThanText = value; }
        ...
        [Parameter]
        public string GreaterThanOrEqualsText { get => greaterThanOrEqualsText ?? Localize(nameof(CrestStrings.DataFilter_GreaterThanOrEqualsText)); set => greaterThanOrEqualsText = value; }
        ...
        [Parameter]
        public string EndsWithText { get => endsWithText ?? Localize(nameof(CrestStrings.DataFilter_EndsWithText)); set => endsWithText = value; }
        ...
        [Parameter]
        public string ContainsText { get => containsText ?? Localize(nameof(CrestStrings.DataFilter_ContainsText)); set => containsText = value; }
        ...
        [Parameter]
        public string DoesNotContainText { get => doesNotContainText ?? Localize(nameof(CrestStrings.DataFilter_DoesNotContainText)); set => doesNotContainText = value; }
        ...
        [Parameter]
        public string InText { get => inText ?? Localize(nameof(CrestStrings.DataFilter_InText)); set => inText = value; }
        ...
        [Parameter]
        public string NotInText { get => notInText ?? Localize(nameof(CrestStrings.DataFilter_NotInText)); set => notInText = value; }
        ...
        [Parameter]
        public string StartsWithText { get => startsWithText ?? Localize(nameof(CrestStrings.DataFilter_StartsWithText)); set => startsWithText = value; }
        ...
        [Parameter]
        public string IsNotNullText { get => isNotNullText ?? Localize(nameof(CrestStrings.DataFilter_IsNotNullText)); set => isNotNullText = value; }
        ...
        [Parameter]
        public string IsNullText { get => isNullText ?? Localize(nameof(CrestStrings.DataFilter_IsNullText)); set => isNullText = value; }
        ...
        [Parameter]
        public string IsEmptyText { get => isEmptyText ?? Localize(nameof(CrestStrings.DataFilter_IsEmptyText)); set => isEmptyText = value; }
        ...
        [Parameter]
        public string IsNotEmptyText { get => isNotEmptyText ?? Localize(nameof(CrestStrings.DataFilter_IsNotEmptyText)); set => isNotEmptyText = value; }
        ...
        [Parameter]
        public string CustomText { get => customText ?? Localize(nameof(CrestStrings.DataFilter_CustomText)); set => customText = value; }
        ...
        [Parameter]
        public string PropertyAriaLabel { get => propertyAriaLabel ?? Localize(nameof(CrestStrings.DataFilter_PropertyAriaLabel)); set => propertyAriaLabel = value; }
        ...
        [Parameter]
        public string FilterOperatorAriaLabel { get => filterOperatorAriaLabel ?? Localize(nameof(CrestStrings.DataFilter_FilterOperatorAriaLabel)); set => filterOperatorAriaLabel = value; }
        ...
        [Parameter]
        public string FilterValueAriaLabel { get => filterValueAriaLabel ?? Localize(nameof(CrestStrings.DataFilter_FilterValueAriaLabel)); set => filterValueAriaLabel = value; }
        ...
        public IList<CrestDataFilterProperty<TItem>> PropertiesCollection
        {
            get
            {
                return properties;
        ...
        internal List<CrestDataFilterProperty<TItem>> properties = new List<CrestDataFilterProperty<TItem>>();
        internal void AddProperty(CrestDataFilterProperty<TItem> property)
        {
        ...
        internal void RemoveProperty(CrestDataFilterProperty<TItem> property)
        {
