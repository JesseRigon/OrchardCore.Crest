...
{
    /// <summary>
    /// CrestDataFilterProperty component.
    /// Must be placed inside a <see cref="CrestDataFilter{TItem}" />
    /// </summary>
    ...
    public partial class CrestDataFilterProperty<TItem> : ComponentBase, IDisposable
    {
        ...
        [CascadingParameter]
        public CrestDataFilter<TItem>? DataFilter { get; set; }
        ...
        internal void RemoveColumn(CrestDataFilterProperty<TItem> property)
        {
