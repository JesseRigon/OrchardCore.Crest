...
/// <summary>
/// CrestFabMenu component.
/// </summary>
/// <example>
/// <code>
/// &lt;CrestFabMenu Icon="add" ToggleIcon="close" AriaLabel="Open menu"&gt;
///     &lt;CrestFabMenuItem Text="Folder" Icon="folder" Click=@(args => Console.WriteLine("Folder clicked")) /&gt;
///     &lt;CrestFabMenuItem Text="Chat" Icon="chat" Click=@(args => Console.WriteLine("Chat clicked")) /&gt;
/// &lt;/CrestFabMenu&gt;
/// </code>
/// </example>
public partial class CrestFabMenu : CrestComponent
{
    /// <summary>
    ...
    /// <summary>
    /// Gets or sets a value indicating whether this <see cref="CrestFabMenu"/> is disabled.
    /// </summary>
