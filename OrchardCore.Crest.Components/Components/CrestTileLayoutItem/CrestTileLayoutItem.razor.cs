...
{
    /// <summary>
    /// A tile displayed inside a <see cref="CrestTileLayout" />. Each tile occupies a
    ...
    /// <example>
    /// <code>
    /// &lt;CrestTileLayout Columns="12" EditMode="true"&gt;
    ///     &lt;CrestTileLayoutItem Title="Sales" Icon="paid" Col="1" Row="1" ColSpan="4" RowSpan="2"&gt;
    ///         Content
    ///     &lt;/CrestTileLayoutItem&gt;
    /// &lt;/CrestTileLayout&gt;
    /// </code>
    /// </example>
    public partial class CrestTileLayoutItem : CrestComponent
    {
        /// <summary>
        /// Gets or sets the parent layout.
        /// </summary>
        [CascadingParameter]
        public CrestTileLayout? Layout { get; set; }
