...
{
    /// <summary>
    /// CrestProfileMenu component.
    /// </summary>
    /// <example>
    /// <code>
    /// &lt;CrestProfileMenu&gt;
    ///     &lt;CrestProfileMenuItem Text="Data"&gt;
    ///         &lt;CrestProfileMenuItem Text="Orders" Path="orders" /&gt;
    ///         &lt;CrestProfileMenuItem Text="Employees" Path="employees" /&gt;
    ///     &lt;/CrestProfileMenuItemItem&gt;
    /// &lt;/CrestProfileMenu&gt;
    /// </code>
    /// </example>
    public partial class CrestProfileMenu : CrestComponentWithChildren
    {
        /// <inheritdoc />
        ...
        [Parameter]
        public EventCallback<CrestProfileMenuItem> Click { get; set; }
        ...
        [Parameter]
        public string ToggleAriaLabel { get => toggleAriaLabel ?? Localize(nameof(CrestStrings.ProfileMenu_ToggleAriaLabel)); set => toggleAriaLabel = value; }
        ...
        internal bool IsFocused(CrestProfileMenuItem item)
        {
            return items.IndexOf(item) == focusedIndex && focusedIndex != -1;
        }

        internal List<CrestProfileMenuItem> items = new List<CrestProfileMenuItem>();
        /// <summary>
        /// Adds the item.
        /// </summary>
        /// <param name="item">The item.</param>
        public void AddItem(CrestProfileMenuItem item)
        {
