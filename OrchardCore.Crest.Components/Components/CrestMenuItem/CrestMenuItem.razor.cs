...
{
    /// <summary>
    /// CrestMenuItem component.
    /// </summary>
    public partial class CrestMenuItem : CrestComponent
    {
        /// <inheritdoc />
        ...
        /// <value>The text.</value>
        [Parameter]
        public string ImageAlternateText { get => imageAlternateText ?? Localize(nameof(CrestStrings.MenuItem_ImageAlternateText)); set => imageAlternateText = value; }
        ...
        [CascadingParameter]
        public CrestMenuItem? ParentItem
        {
            get
            {
                return _parentItem;
