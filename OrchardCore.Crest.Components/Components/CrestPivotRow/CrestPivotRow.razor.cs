...
{
    /// <summary>
    /// CrestPivotRow component. Must be placed inside a <see cref="CrestPivotDataGrid{TItem}" />
    /// </summary>
    /// <typeparam name="TItem">The type of the PivotDataGrid item.</typeparam>
    public partial class CrestPivotRow<TItem> : CrestPivotField<TItem>, IDisposable
    {
        /// <summary>
