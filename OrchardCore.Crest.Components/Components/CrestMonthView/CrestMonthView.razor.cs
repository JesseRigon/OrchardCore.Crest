...
namespace Crest.Components.Primitives
{
    ...
    /// </code>
    /// </example>
    public partial class CrestMonthView : SchedulerViewBase
    {
        /// <inheritdoc />
        ...
        /// <inheritdoc />
        [Parameter]
        public override string Text { get => text ?? Localize(nameof(CrestStrings.MonthView_Text)); set => text = value; }
        private string? text;
        ...
        [Parameter]
        public string MoreText { get => moreText ?? Localize(nameof(CrestStrings.MonthView_MoreText)); set => moreText = value; }
