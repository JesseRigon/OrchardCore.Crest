...
namespace Crest.Components.Primitives
{
    ...
    /// CrestLink provides styled links with icon support, active state highlighting, and disabled states.
    ...
    /// <code>
    /// &lt;CrestLink Path="/products" Text="View Products" Icon="shopping_cart" /&gt;
    /// </code>
    ...
    /// </code>
    /// </example>
    public partial class CrestLink : CrestComponent
    {
        ...
        [Parameter]
        public string ImageAlternateText { get => imageAlternateText ?? Localize(nameof(CrestStrings.Link_ImageAlternateText)); set => imageAlternateText = value; }
