...
{
    /// <summary>
    /// Renders 100% stacked bar series in <see cref="CrestChart" />.
    /// Each category's values are normalized so they total 100%.
    /// </summary>
    /// <typeparam name="TItem">The type of the series data item.</typeparam>
    public partial class CrestFullStackedBarSeries<TItem> : CartesianSeries<TItem>, IChartFullStackedBarSeries
    {
        /// <summary>
