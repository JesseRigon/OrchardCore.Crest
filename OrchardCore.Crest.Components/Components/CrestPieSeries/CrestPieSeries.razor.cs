...
namespace Crest.Components.Primitives
{
    ...
    /// CrestPieSeries is ideal for showing percentage breakdowns, composition analysis, or relative comparisons of parts to a total.
    ...
    /// Use CategoryProperty for segment labels (shown in legend/tooltip) and ValueProperty for the numeric value determining segment size. For a donut chart (pie with hollow center), use CrestDonutSeries instead.
    /// </summary>
    ...
    /// <code>
    /// &lt;CrestChart&gt;
    ///     &lt;CrestPieSeries Data=@marketShare CategoryProperty="Company" ValueProperty="Share" /&gt;
    /// &lt;/CrestChart&gt;
    /// </code>
    /// Pie with custom colors and data labels:
    /// <code>
    /// &lt;CrestChart&gt;
    ///     &lt;CrestPieSeries Data=@data CategoryProperty="Category" ValueProperty="Value" 
    ///                      Fills=@(new[] { "#FF6384", "#36A2EB", "#FFCE56", "#4BC0C0" })&gt;
    ///         &lt;CrestSeriesDataLabels Visible="true" /&gt;
    ///     &lt;/CrestPieSeries&gt;
    /// &lt;/CrestChart&gt;
    /// </code>
    /// </example>
    [UnconditionalSuppressMessage(TrimMessages.Trimming, TrimMessages.IL2026, Justification = TrimMessages.DataTypePreserved)]
    public partial class CrestPieSeries<TItem> : CartesianSeries<TItem>
    {
        /// <summary>
