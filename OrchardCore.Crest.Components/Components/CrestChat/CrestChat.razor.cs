...
{
    /// <summary>
    /// Provides information about a typing state change in <see cref="CrestChat"/>.
    /// </summary>
    ...
    /// <summary>
    /// Represents a chat participant in the CrestChat component.
    /// </summary>
    ...
    /// CrestChat provides a complete chat UI with message history, user avatars, typing indicators, and message composition.
    ...
    /// Basic chat:
    /// <code>
    /// &lt;CrestChat CurrentUserId=@currentUserId Users=@users Messages=@messages MessageSent=@OnMessageSent /&gt;
    /// @code {
    ...
    /// </code>
    /// </example>
    public partial class CrestChat : CrestComponent
    {
        ...
        [Parameter]
        public string? TypingFormat { get => typingFormat ?? Localize(nameof(CrestStrings.Chat_TypingFormat)); set => typingFormat = value; }
        ...
        [Parameter]
        public string? TwoUsersTypingFormat { get => twoUsersTypingFormat ?? Localize(nameof(CrestStrings.Chat_TwoUsersTypingFormat)); set => twoUsersTypingFormat = value; }
        ...
        [Parameter]
        public string? MultipleUsersTypingFormat { get => multipleUsersTypingFormat ?? Localize(nameof(CrestStrings.Chat_MultipleUsersTypingFormat)); set => multipleUsersTypingFormat = value; }
        ...
        /// </summary>
        [Parameter]
        public string Placeholder { get => placeholder ?? Localize(nameof(CrestStrings.Chat_Placeholder)); set => placeholder = value; }
        ...
        /// </summary>
        [Parameter]
        public string EmptyMessage { get => emptyMessage ?? Localize(nameof(CrestStrings.Chat_EmptyMessage)); set => emptyMessage = value; }
        ...
        /// </summary>
        [Parameter]
        public string NewMessagesText { get => newMessagesText ?? Localize(nameof(CrestStrings.Chat_NewMessagesText)); set => newMessagesText = value; }
