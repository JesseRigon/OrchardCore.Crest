...
{
    /// <summary>
    /// A chart series that displays data as a waterfall chart in a CrestChart.
    ...
    /// <code>
    /// &lt;CrestChart&gt;
    ///     &lt;CrestWaterfallSeries Data=@data CategoryProperty="Label" ValueProperty="Amount"
    ///         SummaryProperty="IsTotal" Title="Cash Flow" /&gt;
    /// &lt;/CrestChart&gt;
    /// </code>
    /// </example>
    [UnconditionalSuppressMessage(TrimMessages.Trimming, TrimMessages.IL2026, Justification = TrimMessages.DataTypePreserved)]
    public partial class CrestWaterfallSeries<TItem> : CartesianSeries<TItem>, IChartColumnSeries
    {
        /// <summary>
