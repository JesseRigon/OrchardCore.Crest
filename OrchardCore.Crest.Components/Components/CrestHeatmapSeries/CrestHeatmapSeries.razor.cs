...
namespace Crest.Components.Primitives
{
    ...
    /// <code>
    /// &lt;CrestChart&gt;
    ///     &lt;CrestHeatmapSeries Data=@grid CategoryProperty="X" ValueProperty="Y" IntensityProperty="Lux"
    ///         ColorRange="@ranges" Title="Illuminance" /&gt;
    ///     &lt;CrestCategoryAxis Min="0" Max="5" /&gt;
    ///     &lt;CrestValueAxis Min="0" Max="5" /&gt;
    /// &lt;/CrestChart&gt;
    /// </code>
    /// </example>
    [UnconditionalSuppressMessage(TrimMessages.Trimming, TrimMessages.IL2026, Justification = TrimMessages.DataTypePreserved)]
    public partial class CrestHeatmapSeries<TItem> : CartesianSeries<TItem>
    {
        /// <summary>
        ...
        /// </summary>
        [Parameter]
        public string IntensityLabel { get => intensityLabel ?? Chart?.Localize(nameof(CrestStrings.HeatmapSeries_IntensityLabel)) ?? "Value"; set => intensityLabel = value; }
