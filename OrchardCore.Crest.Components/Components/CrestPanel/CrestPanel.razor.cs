...
namespace Crest.Components.Primitives
{
    ...
    /// CrestPanel provides an expandable/collapsible container for organizing and hiding content, ideal for settings panels, detail sections, or grouped information.
    ...
    /// <code>
    /// &lt;CrestPanel Text="Advanced Options" Icon="settings" AllowCollapse="true"&gt;
    ///     &lt;CrestStack Gap="1rem"&gt;
    ///         &lt;CrestCheckBox @bind-Value=@option1 Text="Option 1" /&gt;
    ///         &lt;CrestCheckBox @bind-Value=@option2 Text="Option 2" /&gt;
    ///     &lt;/CrestStack&gt;
    /// &lt;/CrestPanel&gt;
    /// </code>
    ...
    ///     &lt;/ChildContent&gt;
    ///     &lt;SummaryTemplate&gt;
    ///         &lt;CrestText TextStyle="TextStyle.Caption"&gt;Click to expand details&lt;/CrestText&gt;
    ///     &lt;/SummaryTemplate&gt;
    /// &lt;/CrestPanel&gt;
    /// @code {
    ...
    /// </code>
    /// </example>
    public partial class CrestPanel : CrestComponentWithChildren
    {
        /// <inheritdoc />
        ...
        [Parameter]
        public string CollapseTitle { get => collapseTitle ?? Localize(nameof(CrestStrings.Panel_CollapseTitle)); set => collapseTitle = value; }
