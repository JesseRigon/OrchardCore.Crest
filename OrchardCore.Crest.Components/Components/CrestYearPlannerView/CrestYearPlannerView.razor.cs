...
namespace Crest.Components.Primitives
{
    ...
    /// </code>
    /// </example>
    public partial class CrestYearPlannerView : SchedulerYearViewBase
    {
        /// <inheritdoc />
        ...
        /// <inheritdoc />
        [Parameter]
        public override string Text { get => text ?? Localize(nameof(CrestStrings.YearPlannerView_Text)); set => text = value; }
        private string? text;
        ...
        [Parameter]
        public string MoreText { get => moreText ?? Localize(nameof(CrestStrings.YearPlannerView_MoreText)); set => moreText = value; }
