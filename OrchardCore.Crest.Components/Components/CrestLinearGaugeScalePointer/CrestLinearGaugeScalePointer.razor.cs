...
{
    /// <summary>
    /// CrestLinearGaugeScalePointer component.
    /// </summary>
    public partial class CrestLinearGaugeScalePointer : ComponentBase, IDisposable
    {
        /// <summary>
        ...
        /// </summary>
        [CascadingParameter]
        public CrestLinearGaugeScale? Scale { get; set; }
        ...
        /// </summary>
        [Parameter]
        public RenderFragment<CrestLinearGaugeScalePointer>? Template { get; set; }
