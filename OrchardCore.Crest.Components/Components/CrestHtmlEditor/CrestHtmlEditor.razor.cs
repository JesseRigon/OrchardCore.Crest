...
namespace Crest.Components.Primitives
{
    ...
    /// CrestHtmlEditor provides a full-featured editor for creating and editing formatted content with a Microsoft Word-like interface.
    ...
    /// built-in image upload with configurable upload URL, custom toolbar buttons via CrestHtmlEditorCustomTool, toggle between visual editing and HTML source code view,
    ...
    /// Basic HTML editor:
    /// <code>
    /// &lt;CrestHtmlEditor @bind-Value=@htmlContent Style="height: 400px;" /&gt;
    /// @code {
    ...
    /// <code>
    /// &lt;CrestHtmlEditor @bind-Value=@content UploadUrl="api/upload/image" UploadHeaders=@uploadHeaders&gt;
    ///     &lt;CrestHtmlEditorBold /&gt;
    ///     &lt;CrestHtmlEditorItalic /&gt;
    ///     &lt;CrestHtmlEditorUnderline /&gt;
    ///     &lt;CrestHtmlEditorSeparator /&gt;
    ///     &lt;CrestHtmlEditorImage /&gt;
    /// &lt;/CrestHtmlEditor&gt;
    /// </code>
    /// Editor with custom tool:
    /// <code>
    /// &lt;CrestHtmlEditor @bind-Value=@html Execute=@OnExecute&gt;
    ///     &lt;CrestHtmlEditorCustomTool CommandName="InsertDate" Icon="calendar_today" Title="Insert Current Date" /&gt;
    /// &lt;/CrestHtmlEditor&gt;
    /// @code {
    ...
    public partial class CrestHtmlEditor : FormComponent<string>
    {
        ...
        /// <example>
        /// <code>
        /// &lt;CrestHtmlEditor @bind-Value=@html Paste=@OnPaste /&gt;
        /// @code {
        ...
        /// <example>
        /// <code>
        /// &lt;CrestHtmlEditor Execute=@OnExecute&gt;
        ///   &lt;CrestHtmlEditorCustomTool CommandName="InsertToday" Icon="today" Title="Insert today" /&gt;
        /// &lt;/CrestHtmlEditor&gt;
        /// @code {
        ///   string html = "@lt;strong&gt;Hello&lt;/strong&gt; world!";
        ///   async Task OnExecute(HtmlEditorExecuteEventArgs args)
        ...
        /// <summary>
        /// Specifies the URL to which CrestHtmlEditor will submit files.
        /// </summary>
        [Parameter]
        public string? UploadUrl { get; set; }

        ElementReference ContentEditable { get; set; }
        CrestTextArea? TextArea { get; set; }
        ...
        /// <summary>
        /// Represents the current state of the toolbar commands and other functionalities within the CrestHtmlEditor component.
        /// Updated dynamically based on user actions or programmatically invoked commands.
        /// </summary>
        public CrestHtmlEditorCommandState State { get; set; } = new();
        ...
        /// <summary>
        /// Invoked by interop when the CrestHtmlEditor selection changes.
        /// </summary>
        [JSInvokable]
        ...
        public async Task OnContextMenu(double clientX, double clientY)
        {
            ...
            {
                new ContextMenuItem { Text = TableStrings.CopyCells ?? Localize(nameof(CrestStrings.HtmlEditorTable_CopyCells)), Value = "copyCells", Icon = "content_copy" },
                new ContextMenuItem { Text = TableStrings.PasteCells ?? Localize(nameof(CrestStrings.HtmlEditorTable_PasteCells)), Value = "pasteCells", Icon = "content_paste" },
                new ContextMenuItem { Text = TableStrings.InsertRowAbove ?? Localize(nameof(CrestStrings.HtmlEditorTable_InsertRowAbove)), Value = "addRowBefore", Icon = "north" },
                new ContextMenuItem { Text = TableStrings.InsertRowBelow ?? Localize(nameof(CrestStrings.HtmlEditorTable_InsertRowBelow)), Value = "addRowAfter", Icon = "south" },
                new ContextMenuItem { Text = TableStrings.InsertColumnLeft ?? Localize(nameof(CrestStrings.HtmlEditorTable_InsertColumnLeft)), Value = "addColumnBefore", Icon = "west" },
                new ContextMenuItem { Text = TableStrings.InsertColumnRight ?? Localize(nameof(CrestStrings.HtmlEditorTable_InsertColumnRight)), Value = "addColumnAfter", Icon = "east" },
                new ContextMenuItem { Text = TableStrings.DeleteRow ?? Localize(nameof(CrestStrings.HtmlEditorTable_DeleteRow)), Value = "deleteRow", Icon = "horizontal_rule" },
                new ContextMenuItem { Text = TableStrings.DeleteColumn ?? Localize(nameof(CrestStrings.HtmlEditorTable_DeleteColumn)), Value = "deleteColumn", Icon = "vertical_align_center" },
                new ContextMenuItem { Text = TableStrings.MergeRight ?? Localize(nameof(CrestStrings.HtmlEditorTable_MergeRight)), Value = "mergeCellRight", Icon = "merge_type", Disabled = !TableSelection.CanMergeRight },
                new ContextMenuItem { Text = TableStrings.MergeDown ?? Localize(nameof(CrestStrings.HtmlEditorTable_MergeDown)), Value = "mergeCellDown", Icon = "merge", Disabled = !TableSelection.CanMergeDown },
                new ContextMenuItem { Text = TableStrings.SplitCell ?? Localize(nameof(CrestStrings.HtmlEditorTable_SplitCell)), Value = "splitCell", Icon = "call_split", Disabled = !TableSelection.CanSplit },
                new ContextMenuItem { Text = TableStrings.DeleteTable ?? Localize(nameof(CrestStrings.HtmlEditorTable_DeleteTable)), Value = "deleteTable", Icon = "delete", IconColor = "var(--rz-danger)", Disabled = !TableSelection.InTable }
            };
        ...
        /// <summary>
        /// Executes the action associated with the specified shortcut. Used internally by CrestHtmlEditor.
        /// </summary>
        ...
        /// <summary>
        /// Saves the current selection. CrestHtmlEditor will lose its selection when it loses focus. Use this method to persist the current selection.
        /// </summary>
        ...
        public async Task ExecuteTableCommandAsync(string name, HtmlEditorTableCommandArgs? value = null)
        {
            ...
            {
                NotificationService?.Notify(NotificationSeverity.Warning, TableStrings.ActionBlocked ?? Localize(nameof(CrestStrings.HtmlEditorTable_ActionBlocked)), GetTableCommandMessage(State.Message), 4000);
        ...
        string GetTableCommandMessage(string message)
        {
            ...
            {
                "table.action.requiresTable" => TableStrings.ActionRequiresTable ?? Localize(nameof(CrestStrings.HtmlEditorTable_ActionRequiresTable)),
                "table.copy.invalidSelection" => TableStrings.CopyInvalidSelection ?? Localize(nameof(CrestStrings.HtmlEditorTable_CopyInvalidSelection)),
                "table.paste.blocked" => TableStrings.PasteBlocked ?? Localize(nameof(CrestStrings.HtmlEditorTable_PasteBlocked)),
                "table.merge.invalidSelection" => TableStrings.MergeInvalidSelection ?? Localize(nameof(CrestStrings.HtmlEditorTable_MergeInvalidSelection)),
                _ => message
            };
        }
        ...
        /// <summary>
        /// Invoked via interop when the value of CrestHtmlEditor changes.
        /// </summary>
        ...
        /// <summary>
        /// Invoked via interop when the user pastes content in CrestHtmlEditor. Invokes <see cref="Paste" />.
        /// </summary>
        /// <param name="html">The HTML.</param>
        [JSInvokable]
