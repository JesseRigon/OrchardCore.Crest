...
{
    /// <summary>
    /// CrestPivotAggregate component. Must be placed inside a <see cref="CrestPivotDataGrid{TItem}" />
    /// </summary>
    /// <typeparam name="TItem">The type of the PivotDataGrid item.</typeparam>
    public partial class CrestPivotAggregate<TItem> : CrestPivotField<TItem>, IDisposable
    {
        /// <summary>
        ...
        /// </summary>
        [Parameter]
        public RenderFragment<CrestPivotAggreateContext<TItem>>? RowTotalTemplate { get; set; }
