...
{
    /// <summary>
    /// A chart series that displays data as vertical columns (bars) in a CrestChart.
    /// CrestColumnSeries is ideal for comparing values across categories or showing trends over time with discrete data points.
    ...
    /// <code>
    /// &lt;CrestChart&gt;
    ///     &lt;CrestColumnSeries Data=@revenue CategoryProperty="Quarter" ValueProperty="Amount" Title="Revenue" /&gt;
    /// &lt;/CrestChart&gt;
    /// </code>
    /// Multiple column series with custom colors:
    /// <code>
    /// &lt;CrestChart&gt;
    ///     &lt;CrestColumnSeries Data=@sales2023 CategoryProperty="Month" ValueProperty="Total" Title="2023" Fill="#4169E1" /&gt;
    ///     &lt;CrestColumnSeries Data=@sales2024 CategoryProperty="Month" ValueProperty="Total" Title="2024" Fill="#32CD32" /&gt;
    /// &lt;/CrestChart&gt;
    /// </code>
    /// </example>
    public partial class CrestColumnSeries<TItem> : CartesianSeries<TItem>, IChartColumnSeries
    {
        /// <summary>
