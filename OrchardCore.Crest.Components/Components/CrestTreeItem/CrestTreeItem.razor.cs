...
{
    /// <summary>
    /// A component which is an item in a <see cref="CrestTree" />
    /// </summary>
    public partial class CrestTreeItem : IDisposable
    {
        /// <summary>
        ...
        /// </summary>
        [CascadingParameter]
        public CrestTree? Tree { get; set; }

        /// <summary>
        /// The CrestTreeItem which contains this item.
        /// </summary>
        [CascadingParameter]
        public CrestTreeItem? ParentItem { get; set; }
        ...
        List<CrestTreeItem> Siblings => ParentItem?.items ?? Tree?.items ?? new List<CrestTreeItem>();
        ...
        internal bool Contains(CrestTreeItem child)
        {
