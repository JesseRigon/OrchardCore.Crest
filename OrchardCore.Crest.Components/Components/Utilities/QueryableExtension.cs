...
namespace Crest.Components.Primitives
{
    ...
    public static class QueryableExtension
    {
        ...
        [RequiresUnreferencedCode(ReflectionWarning)]
        public static string ToFilterString<T>(this IEnumerable<CrestDataGridColumn<T>> columns) where T : notnull
        {
            Func<CrestDataGridColumn<T>, bool> canFilter = (c) => c.Filterable && c.FilterPropertyType != null &&
            ...
            Func<CrestDataGridColumn<T>, bool> canFilterCustom = (c) => c.Filterable && c.FilterPropertyType != null &&
        ...
        /// <summary>
        /// Converts a CrestDataFilter to a Linq-compatibly filter string
        /// </summary>
        /// <typeparam name="T">The type that is being filtered</typeparam>
        /// <param name="dataFilter">The CrestDataFilter component</param>
        /// <returns>A Linq-compatible filter string</returns>
        [RequiresUnreferencedCode(ReflectionWarning)]
        public static string ToFilterString<T>(this CrestDataFilter<T> dataFilter)
        {
        ...
        /// <returns>System.String.</returns>
        [RequiresUnreferencedCode(ReflectionWarning)]
        internal static string GetColumnODataFilter<T>(CrestDataGridColumn<T> column, object? filterValue, FilterOperator columnFilterOperator) where T : notnull
        {
        ...
        /// <returns>System.String.</returns>
        [RequiresUnreferencedCode(ReflectionWarning)]
        public static string ToODataFilterString<T>(this IEnumerable<CrestDataGridColumn<T>> columns) where T : notnull
        {
        ...
        [RequiresUnreferencedCode(ReflectionWarning)]
        public static IQueryable<T> Where<T>(this IQueryable<T> source, IEnumerable<CrestDataGridColumn<T>> columns) where T : notnull
        {
            ArgumentNullException.ThrowIfNull(source);
        ...
        /// <returns>IQueryable&lt;T&gt;.</returns>
        [RequiresUnreferencedCode(ReflectionWarning)]
        public static IQueryable<T> Where<T>(this IQueryable<T> source, CrestDataFilter<T> dataFilter)
        {
            ArgumentNullException.ThrowIfNull(source);
            ArgumentNullException.ThrowIfNull(dataFilter);
        ...
        /// <returns>System.String.</returns>
        [RequiresUnreferencedCode(ReflectionWarning)]
        public static string ToODataFilterString<T>(this CrestDataFilter<T> dataFilter)
        {
            ArgumentNullException.ThrowIfNull(dataFilter);
            Func<CompositeFilterDescriptor, bool> canFilter = (c) => dataFilter.properties.Where(col => col.Property == c.Property).FirstOrDefault()?.FilterPropertyType != null &&
               (!(c.FilterValue == null || (c.FilterValue as string)?.Length == 0)
        ...
        private static List<CrestDataGridColumn<T>> GetFilterableColumns<T>(IEnumerable<CrestDataGridColumn<T>> columns) where T : notnull
        {
            return columns
