...
{
    /// <summary>
    /// CrestMediaQuery fires its <see cref="Change" /> event when the media query specified via <see cref="Query" /> matches or not.
    /// </summary>
    /// <example>
    /// &lt; CrestMediaQuery Query="(max-width: 768px)" Change=@OnChange /&gt;
    /// @code {
    ...
    ///}
    /// </example>
    public class CrestMediaQuery : ComponentBase, IDisposable
    {
        ...
        bool initialized;
        private DotNetObjectReference<CrestMediaQuery>? reference;
