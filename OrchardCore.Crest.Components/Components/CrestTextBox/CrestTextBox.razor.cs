...
namespace Crest.Components.Primitives
{
    ...
    /// CrestTextBox provides a styled text input with support for placeholders, autocomplete, immediate updates, and string trimming.
    /// Supports two-way data binding via @bind-Value and form validation when used within Crest forms.
    ...
    /// <code>
    /// &lt;CrestTextBox @bind-Value=@username Placeholder="Enter username" /&gt;
    /// </code>
    /// With immediate updates and trimming:
    /// <code>
    /// &lt;CrestTextBox @bind-Value=@value Immediate="true" Trim="true" MaxLength="50" /&gt;
    /// </code>
    /// Read-only text box:
    /// <code>
    /// &lt;CrestTextBox Value=@displayValue ReadOnly="true" /&gt;
    /// </code>
    /// </example>
    public partial class CrestTextBox : FormComponentWithAutoComplete<string>
    {
        /// <summary>
