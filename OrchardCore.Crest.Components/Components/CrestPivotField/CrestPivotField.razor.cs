...
{
    /// <summary>
    /// Base component for CrestPivotDataGrid Rows, Columns and Aggregates.
    /// </summary>
    ...
    public partial class CrestPivotField<TItem> : ComponentBase, IDisposable
    {
        /// <summary>
        ...
        /// </summary>
        [Parameter]
        public RenderFragment<CrestPivotField<TItem>>? FilterTemplate { get; set; }

        /// <summary>
        /// Gets or sets the filter value template.
        /// </summary>
        [Parameter]
        public RenderFragment<CrestPivotField<TItem>>? FilterValueTemplate { get; set; }

        /// <summary>
        /// Gets or sets the second filter value template.
        /// </summary>
        [Parameter]
        public RenderFragment<CrestPivotField<TItem>>? SecondFilterValueTemplate { get; set; }
        ...
        /// </summary>
        [CascadingParameter]
        public CrestPivotDataGrid<TItem>? PivotGrid { get; set; }
