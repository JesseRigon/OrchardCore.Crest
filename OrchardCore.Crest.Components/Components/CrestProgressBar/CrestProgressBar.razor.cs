...
namespace Crest.Components.Primitives
{
    ...
    /// CrestProgressBar displays progress horizontally with determinate (specific value) or indeterminate (ongoing) modes.
    ...
    /// <code>
    /// &lt;CrestProgressBar Value=@progress Max="100" ShowValue="true" ProgressBarStyle="ProgressBarStyle.Primary" /&gt;
    /// @code {
    ...
    /// @if (isLoading)
    /// {
    ///     &lt;CrestProgressBar Mode="ProgressBarMode.Indeterminate" ProgressBarStyle="ProgressBarStyle.Info" /&gt;
    /// }
    /// </code>
    /// Custom range and unit:
    /// <code>
    /// &lt;CrestProgressBar Value=@bytesDownloaded Min="0" Max=@totalBytes Unit="MB" ShowValue="true" /&gt;
    /// </code>
    /// </example>
    public partial class CrestProgressBar
    {
        /// <inheritdoc />
