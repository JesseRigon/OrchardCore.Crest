...
/// </summary>
public static class CrestQREncoder
{
    /// <summary>Encode a UTF-8 string into a QR module matrix.</summary>
    public static bool[,] EncodeUtf8(string value, CrestQREcc ecc, int minVersion = 1, int maxVersion = 40)
    {
    ...
    public static bool[,] EncodeBytes(byte[] data, CrestQREcc ecc = CrestQREcc.Medium, int minVersion = 1, int maxVersion = 40)
    {
    ...
    private static void WriteFormatInfo(bool[,] m, bool[,] res, CrestQREcc ecc, int mask)
    {
        // ECL bits: L=01, M=00, Q=11, H=10
        int ecl = ecc switch { CrestQREcc.Low => 1, CrestQREcc.Medium => 0, CrestQREcc.Quartile => 3, CrestQREcc.High => 2, _ => 0 };
    ...
    static (int totalDataCw, int ecPerBlock, int grp1Blocks, int grp1DataCw, int grp2Blocks, int grp2DataCw)
        EcParams(int ver, CrestQREcc ecc)
    {
        if (ver < 1 || ver > 40)
        {
        ...
        {
            CrestQREcc.Low => 0, // L
            CrestQREcc.Medium => 1, // M
            CrestQREcc.Quartile => 2, // Q
            CrestQREcc.High => 3, // H
