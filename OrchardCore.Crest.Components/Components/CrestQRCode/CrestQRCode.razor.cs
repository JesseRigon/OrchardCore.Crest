...
namespace Crest.Components.Primitives
{
    ...
    /// CrestQRCode supports extensive customization including colors, shapes, error correction, and embedded logos.
    ...
    /// <code>
    /// &lt;CrestQRCode Value="https://example.com" Foreground="#4169E1" Background="#F0F0F0"
    ///               Image="logo.png" ImageSizePercent="25" Ecc="CrestQREcc.High"
    ///               ModuleShape="QRCodeModuleShape.Rounded" Size="300px" /&gt;
    /// </code>
    /// </example>
    public partial class CrestQRCode : CrestComponent
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The error correction level. Default is <see cref="CrestQREcc.Quartile"/>.</value>
        [Parameter] public CrestQREcc Ecc { get; set; } = CrestQREcc.Quartile;
