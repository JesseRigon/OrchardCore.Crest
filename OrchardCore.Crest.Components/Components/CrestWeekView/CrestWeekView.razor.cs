...
{
    /// <summary>
    /// Displays the appointments in a week day in <see cref="CrestScheduler{TItem}" />
    /// </summary>
    /// <code>
    ...
    /// &lt;/CrestScheduler&gt;
    /// </code>
    public partial class CrestWeekView : SchedulerViewBase
    {
        /// <inheritdoc />
        ...
        /// <inheritdoc />
        [Parameter]
        public override string Text { get => text ?? Localize(nameof(CrestStrings.WeekView_Text)); set => text = value; }
        private string? text;
