...
namespace Crest.Components.Primitives
{
    ...
    /// CrestSelectBar provides a visually distinct way to select from a limited set of options, commonly used for view modes, filters, or categories.
    ...
    /// Basic select bar:
    /// <code>
    /// &lt;CrestSelectBar @bind-Value=@viewMode TValue="string"&gt;
    ///     &lt;Items&gt;
    ///         &lt;CrestSelectBarItem Text="List" Value="list" Icon="list" /&gt;
    ///         &lt;CrestSelectBarItem Text="Grid" Value="grid" Icon="grid_view" /&gt;
    ///     &lt;/Items&gt;
    /// &lt;/CrestSelectBar&gt;
    /// </code>
    /// Multiple selection for filters:
    /// <code>
    /// &lt;CrestSelectBar @bind-Value=@selectedCategories TValue="IEnumerable&lt;int&gt;" Multiple="true" Size="ButtonSize.Small"&gt;
    ///     &lt;Items&gt;
    ///         &lt;CrestSelectBarItem Text="Electronics" Value="1" /&gt;
    ///         &lt;CrestSelectBarItem Text="Clothing" Value="2" /&gt;
    ///         &lt;CrestSelectBarItem Text="Books" Value="3" /&gt;
    ///     &lt;/Items&gt;
    /// &lt;/CrestSelectBar&gt;
    /// </code>
    /// </example>
    ...
    public partial class CrestSelectBar<TValue> : FormComponent<TValue>, ICrestSelectBar
    {
        ...
        string ButtonClass(CrestSelectBarItem item) => ClassList.Create("rz-button")
        ...
        List<CrestSelectBarItem> allItems = new();
        ...
        void UpdateAllItems()
        {
            ...
            {
                var item = new CrestSelectBarItem();
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="CrestSelectBar{TValue}"/> is multiple.
        /// </summary>
        ...
        List<CrestSelectBarItem> items = new List<CrestSelectBarItem>();

        /// <summary>
        /// Adds the item.
        /// </summary>
        /// <param name="item">The item.</param>
        public void AddItem(CrestSelectBarItem item)
        {
        ...
        /// </summary>
        /// <param name="item">The item.</param>
        public void RemoveItem(CrestSelectBarItem item)
        {
        ...
        protected bool IsSelected(CrestSelectBarItem item)
        {
        ...
        /// </summary>
        /// <param name="item">The item.</param>
        protected async Task SelectItem(CrestSelectBarItem item)
        {
            ArgumentNullException.ThrowIfNull(item);
        ...
        List<CrestSelectBarItem> NavigableItems => allItems.Where(i => i.Visible).ToList();
        ...
        bool IsFocused(CrestSelectBarItem item)
        {
