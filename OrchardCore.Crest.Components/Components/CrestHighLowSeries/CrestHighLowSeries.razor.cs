...
{
    /// <summary>
    /// A chart series that displays data as vertical high-low lines in a <see cref="CrestChart"/>.
    ...
    /// <code>
    /// &lt;CrestChart&gt;
    ///     &lt;CrestHighLowSeries Data=@data CategoryProperty="Date"
    ...
    public partial class CrestHighLowSeries<TItem> : CartesianSeries<TItem>
    {
        /// <summary>
        ...
        /// Use <see cref="LineType.Dashed"/> or <see cref="LineType.Dotted"/> for non-solid lines.
        /// </summary>
