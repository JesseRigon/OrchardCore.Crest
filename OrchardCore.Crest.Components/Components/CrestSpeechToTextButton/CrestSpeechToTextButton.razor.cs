...
{
    /// <summary>
    /// CrestSpeechToTextButton component. Enables speech to text functionality.
    /// <para>This is only supported on select browsers. See https://caniuse.com/?search=SpeechRecognition</para>
    /// <example>
    /// <code>
    /// &lt;CrestSpeechToTextButton Change=@(args => Console.WriteLine($"Value: {args}")) /&gt;
    /// </code>
    /// </example>
    /// </summary>
    public partial class CrestSpeechToTextButton : CrestComponent
    {
        /// <summary>
        ...
        [Parameter]
        public string Title { get => title ?? Localize(nameof(CrestStrings.SpeechToTextButton_Title)); set => title = value; }
        ...
        /// <value>The message.</value>
        [Parameter]
        public string StopTitle { get => stopTitle ?? Localize(nameof(CrestStrings.SpeechToTextButton_StopTitle)); set => stopTitle = value; }
