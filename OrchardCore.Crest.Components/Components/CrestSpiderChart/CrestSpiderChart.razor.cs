...
namespace Crest.Components.Primitives
{
    ...
    public partial class CrestSpiderChart : CrestComponent, ICrestSpiderChart
    {
        ...
        /// <summary>
        /// Gets or sets child content containing CrestSpiderSeries components.
        /// </summary>
        [Parameter]
        ...
        /// <summary>
        /// Event callback for when a series (or a marker) is clicked. Matches <see cref="CrestChart.SeriesClick" /> behavior.
        /// </summary>
        [Parameter]
        public EventCallback<Crest.Components.Primitives.SeriesClickEventArgs> SeriesClick { get; set; }
        ...
        private async Task InvokeSeriesClick(ICrestSpiderSeries series, string? category = null, double? value = null, object? data = null)
        {
            ...
            await SeriesClick.InvokeAsync(new Crest.Components.Primitives.SeriesClickEventArgs
            {
                Title = series.Title,
                Category = category,
                Value = value,
        ...
        private async Task ShowMarkerTooltip(MouseEventArgs args, ICrestSpiderSeries series, string category, double value)
        {
            ...
            if (JSRuntime != null)
            {
                var rect = await JSRuntime.InvokeAsync<Rect>("Crest.Components.Primitives.clientRect", Element);
        ...
        protected override async Task OnAfterRenderAsync(bool firstRender)
        {
            ...
            if (firstRender || !Width.HasValue || !Height.HasValue)
            {
                ...
                if (JSRuntime != null)
                {
                    rect = await JSRuntime.InvokeAsync<Rendering.Rect>("Crest.Components.Primitives.createResizable", Element, Reference);
                }
                else
                {
        ...
        public override void Dispose()
        {
            ...
            {
                JSRuntime.InvokeVoid("Crest.Components.Primitives.destroyResizable", Element);
