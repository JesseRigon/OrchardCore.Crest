...
namespace Crest.Components.Primitives
{
    ...
    public partial class CrestSpiderChart : CrestComponent, ICrestSpiderChart
    {
        ...
        private async Task ShowMarkerTooltip(MouseEventArgs args, ICrestSpiderSeries series, string category, double value)
        {
            ...
            if (JSRuntime != null)
            {
                var rect = await JSRuntime.InvokeAsync<Rect>("Crest.clientRect", Element);
        ...
        protected override async Task OnAfterRenderAsync(bool firstRender)
        {
            ...
            if (firstRender || !Width.HasValue || !Height.HasValue)
            {
                ...
                if (JSRuntime != null)
                {
                    rect = await JSRuntime.InvokeAsync<Rendering.Rect>("Crest.createResizable", Element, Reference);
                }
                else
                {
        ...
        public override void Dispose()
        {
            ...
            {
                JSRuntime.InvokeVoid("Crest.destroyResizable", Element);
