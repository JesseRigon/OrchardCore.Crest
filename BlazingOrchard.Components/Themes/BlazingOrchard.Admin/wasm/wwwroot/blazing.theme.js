window.blazingTheme = (() => {
  ...
  function setTheme(theme) {
    ...
    try {
      localStorage.setItem('blazing-theme-mode', isDarkTheme(safeTheme) ? 'dark' : 'light');
    } catch {}
  }
  ...
  function apply(radzenTheme, variables) {
    ...
    try {
      const mode = localStorage.getItem('blazing-theme-mode');
  ...
  const localUsersKey = 'blazing-admin-local-users';
