...
function buildSharedAdminChecks() {
  return [
    ...
    { name: 'translations-page', fn: require('./checks/translations-page') },
    ...
    { name: 'menu-editor-provider-menu-sync', fn: require('./checks/menu-editor/provider-menu-sync') },
    { name: 'menu-editor-provider-menu-translation-seed', fn: require('./checks/menu-editor/provider-menu-translation-seed') },
    { name: 'menu-editor-new-menu-content-type-translation', fn: require('./checks/menu-editor/new-menu-content-type-translation') },
    { name: 'menu-editor-caption-context-fallback', fn: require('./checks/menu-editor/caption-context-fallback') },
    { name: 'menu-editor-node-key-stability', fn: require('./checks/menu-editor/node-key-stability') },
    { name: 'menu-editor-rename-culture-scoped', fn: require('./checks/menu-editor/rename-culture-scoped') },
    { name: 'menu-editor-rename-promote-to-translation', fn: require('./checks/menu-editor/rename-promote-to-translation') },
    { name: 'menu-editor-restructure-persistence', fn: require('./checks/menu-editor/restructure-persistence') },
    ...
    { name: 'content-part-lists-page', fn: require('./checks/content-part-lists-page') },
