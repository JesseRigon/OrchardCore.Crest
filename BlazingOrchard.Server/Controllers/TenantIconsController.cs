...
[Route("api/blazing/icons/tenant")]
    ...
    IEnumerable<IIconProvider> iconProviders) : ControllerBase
{
    ...
    private Task<bool> CanManageAsync() => authorizationService.AuthorizeAsync(User, BlazingIconPermissions.ManageTenantIcons);
}
