...
public sealed class ResourceManagementOptionsConfiguration : IConfigureOptions<ResourceManagementOptions>
{
    ...
    static ResourceManagementOptionsConfiguration()
    {
        ...
        _manifest
                .DefineScript("OrchardCore.Crest.Site-vendor-jQuery")
                .SetUrl("~/OrchardCore.Crest.Site/vendor/jquery/jquery.min.js", "~/OrchardCore.Crest.Site/vendor/jquery/jquery.js")
        ...
        _manifest
                .DefineScript("OrchardCore.Crest.Site-vendor-jQuery.slim")
                .SetUrl("~/OrchardCore.Crest.Site/vendor/jquery/jquery.slim.min.js", "~/OrchardCore.Crest.Site/vendor/jquery/jquery.slim.js")
        ...
        _manifest
                .DefineScript("OrchardCore.Crest.Site-vendor-bootstrap")
                .SetDependencies("OrchardCore.Crest.Site-vendor-jQuery")
                .SetUrl("~/OrchardCore.Crest.Site/vendor/bootstrap/js/bootstrap.min.js", "~/OrchardCore.Crest.Site/vendor/bootstrap/js/bootstrap.js")
        ...
        _manifest
                .DefineScript("OrchardCore.Crest.Site-vendor-bootstrap-bundle")
                .SetDependencies("OrchardCore.Crest.Site-vendor-jQuery")
                .SetUrl("~/OrchardCore.Crest.Site/vendor/bootstrap/js/bootstrap.bundle.min.js", "~/OrchardCore.Crest.Site/vendor/bootstrap/js/bootstrap.bundle.js")
        ...
        _manifest
                .DefineStyle("OrchardCore.Crest.Site-vendor-bootstrap")
                .SetUrl("~/OrchardCore.Crest.Site/vendor/bootstrap/css/bootstrap.min.css", "~/OrchardCore.Crest.Site/vendor/bootstrap/css/bootstrap.css")
        ...
        _manifest
                .DefineStyle("OrchardCore.Crest.Site-vendor-font-awesome")
                .SetUrl("~/OrchardCore.Crest.Site/vendor/fontawesome-free/css/all.min.css", "~/OrchardCore.Crest.Site/vendor/fontawesome-free/css/all.css")
        ...
        _manifest
                .DefineScript("OrchardCore.Crest.Site-vendor-font-awesome")
